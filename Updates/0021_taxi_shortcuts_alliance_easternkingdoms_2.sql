...
382, 402, 404, 410, 411, 425, 427, 469, 470, 475, 476, 525, 526, 680, 681, 746, 747, 748, 749, 750, 751, 752, 753);
...
(525, 1, 0, 'Thorium Point - Thelsamar | Takeoff verified: videos'),
(526, 0, 1, 'Thelsamar - Thorium Point | Landing verified: videos'),
(680, 1, 2, 'Thorium Point - Stormwind | Takeoff and landing extracted from verified'),             -- Fill in takeoff
(681, 4, 1, 'Stormwind - Thorium Point | Takeoff and landing extracted and fixed from verified'),   -- Fill in landing
(746, 4, 0, 'Rebel Camp - Booty Bay | Takeoff extracted from verified'),
(747, 0, 2, 'Booty Bay - Rebel Camp | Landing verified: videos'),
(748, 4, 0, 'Rebel Camp - Sentinel Hill | Takeoff extracted from verified'),
(749, 0, 2, 'Sentinel Hill - Rebel Camp | Landing extracted from verified'),
(750, 4, 2, 'Rebel Camp - Darkshire | Takeoff and landing verified: videos'),
(751, 4, 2, 'Darkshire - Rebel Camp | Takeoff verified: videos, landing extracted from verified'),
(752, 4, 2, 'Rebel Camp - Stormwind | Takeoff and landing extracted from verified'),                -- Fill in takeoff
(753, 4, 2, 'Stormwind - Rebel Camp | Takeoff and landing extracted and fixed from verified');      -- Fill in landing
...
-- Alliance:
DELETE FROM `taxi_shortcuts` WHERE `pathid` IN (807);
INSERT INTO `taxi_shortcuts` (`pathid`, `takeoff`, `landing`, `comments`) VALUES
(807, 9, 0, 'Ironforge - Shattered Sun Staging Area | Takeoff verified: videos');
