...
(@GUID + 1, 179665, 1, 1, 6601.08, -4167.38, 658.598, -1.0472, 0, 0, -0.500001, 0.866025, 300, 300, 0, 1),      -- Water Elemental Rifts
(@GUID + 2, 179665, 1, 1, 6498.69, -4173.11, 658.959, 2.32129, 0, 0, 0.91706, 0.398748, 300, 300, 0, 1),
(@GUID + 3, 179665, 1, 1, 6541.6, -4061.05, 658.296, -3.05433, 0, 0, -0.999048, 0.0436174, 300, 300, 0, 1),
(@GUID + 4, 179665, 1, 1, 6466.32, -4035.07, 658.459, 2.23402, 0, 0, 0.898794, 0.438372, 300, 300, 0, 1),
(@GUID + 5, 179665, 1, 1, 6517.87, -3983.42, 658.337, -0.244346, 0, 0, -0.121869, 0.992546, 300, 300, 0, 1);
...
(@GUID + 1, 14457, 1, 1, 0, 0, 6565.35, -4219, 658.379, 2.541548, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 15260, 0, 0, 2),
(@GUID + 2, 14458, 1, 1, 0, 0, 6575.15, -4225.95, 658.283, 2.6083, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2699, 0, 0, 0),
(@GUID + 3, 14458, 1, 1, 0, 0, 6576.6, -4216.88, 658.285, 2.6083, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2784, 0, 0, 0),
(@GUID + 4, 14458, 1, 1, 0, 0, 6568.44, -4230.69, 658.285, 2.6083, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2871, 0, 0, 0);
