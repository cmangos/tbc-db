...
(@GUID + 1, 164820, 230, 1, 831.54, -339.529, -46.682, 0.802851, 0, 0, 0.390731, 0.920505, @TIME, 100, 1),
(@GUID + 2, 164821, 230, 1, 831.54, -339.529, -46.682, 0.802851, 0, 0, 0.390731, 0.920505, @TIME, 100, 1),
(@GUID + 3, 164822, 230, 1, 831.54, -339.529, -46.682, 0.802851, 0, 0, 0.390731, 0.920505, @TIME, 100, 1),
(@GUID + 4, 164823, 230, 1, 831.54, -339.529, -46.682, 0.802851, 0, 0, 0.390731, 0.920505, @TIME, 100, 1),
(@GUID + 5, 164824, 230, 1, 831.54, -339.529, -46.682, 0.802851, 0, 0, 0.390731, 0.920505, @TIME, 100, 1),
(@GUID + 6, 164818, 230, 1, 831.471, -339.58, -46.7698, 0.820305, 0, 0, 0.398749, 0.91706, @TIME, 100, 1),
(@GUID + 7, 161456, 230, 1, 831.471, -339.58, -46.7698, 0.820305, 0, 0, 0.398749, 0.91706, @TIME, 100, 1),
(@GUID + 8, 161457, 230, 1, 831.471, -339.58, -46.7698, 0.820305, 0, 0, 0.398749, 0.91706, @TIME, 100, 1),
(@GUID + 9, 161458, 230, 1, 831.471, -339.58, -46.7698, 0.820305, 0, 0, 0.398749, 0.91706, @TIME, 100, 1),
(@GUID + 10, 161459, 230, 1, 831.471, -339.58, -46.7698, 0.820305, 0, 0, 0.398749, 0.91706, @TIME, 100, 1);
...
UPDATE `creature_template` SET `EquipmentTemplateId` = 4 WHERE `Entry` = 9445;
DELETE FROM `creature_equip_template_raw` WHERE `entry`=4;
insert into `creature_equip_template_raw` (`entry`, `equipmodel1`, `equipmodel2`, `equipmodel3`, `equipinfo1`, `equipinfo2`, `equipinfo3`, `equipslot1`, `equipslot2`, `equipslot3`) values('4','5176','0','0','285280258','0','0','1','0','0');
