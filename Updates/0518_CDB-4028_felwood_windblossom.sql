DELETE FROM `gameobject` WHERE `id` IN (164886,171939,171942,174594,174595,174596,174597,174598,174712,174713,164882,171940,171943,174610,174612,174613,
...
(900024, 174600, 1, 1, 6366.68, -1666.65, 480.265, 5.14872, 0, 0, -0.537299, 0.843392, 3595, 3595, 100, 1),
(900025, 174601, 1, 1, 6433.33, -966.665, 422.408, 2.05949, 0, 0, 0.857167, 0.515038, 3595, 3595, 100, 1),
(900026, 174602, 1, 1, 6292.07, -588.73, 467.669, 1.09956, 0, 0, 0.522498, 0.85264, 3595, 3595, 100, 1),
(900027, 174603, 1, 1, 5266.67, -333.332, 325.469, 2.23402, 0, 0, 0.898793, 0.438373, 3595, 3595, 100, 1),
(900028, 174604, 1, 1, 4866.69, -600.011, 307.548, 0.645772, 0, 0, 0.317305, 0.948324, 3595, 3595, 100, 1),
(900029, 174708, 1, 1, 4757.87, -460.486, 337.843, 0.226892, 0, 0, 0.113203, 0.993572, 3595, 3595, 100, 1),
(900030, 174709, 1, 1, 5533.32, -933.35, 376.883, 1.22173, 0, 0, 0.573576, 0.819152, 3595, 3595, 100, 1),
(900031, 164884, 1, 1, 4066.66, -1233.34, 282.075, 1.44862, 0, 0, 0.66262, 0.748956, -3595, -3595, 100, 1),
(900032, 174711, 1, 1, 5533.32, -933.327, 376.886, 1.309, 0, 0, 0.608761, 0.793354, -3595, -3595, 100, 1),
(900033, 173326, 1, 1, 6233.33, -1533.32, 441.792, 4.72984, 0, 0, -0.700909, 0.713251, -3595, -3595, 100, 1),
(900034, 174619, 1, 1, 6292.06, -588.716, 467.672, 4.79966, 0, 0, -0.67559, 0.737278, -3595, -3595, 100, 1),
(900035, 174620, 1, 1, 5266.68, -333.334, 325.471, 5.58505, 0, 0, -0.34202, 0.939693, -3595, -3595, 100, 1),
(900036, 174616, 1, 1, 6866.67, -1566.67, 496.313, 4.7822, 0, 0, -0.681998, 0.731354, -3595, -3595, 100, 1),
(900037, 174617, 1, 1, 6366.67, -1666.66, 480.267, 3.45576, 0, 0, -0.987688, 0.156436, -3595, -3595, 100, 1),
...
-- already correct
-- UPDATE `gameobject_template` SET `data1` = '3619' WHERE (`entry` = '174604');
-- UPDATE `gameobject_template` SET `data1` = '3617' WHERE (`entry` = '174602');
-- UPDATE `gameobject_template` SET `data1` = '3614' WHERE (`entry` = '174599');

-- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

UPDATE `gameobject` SET `position_x` = '4066.65722656250', `position_y` = '-1233.34204101562500', `position_z` = '282.075439453125000', `orientation` = '5.131268978118896484', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.54463863372802734', `rotation3` = '0.838670849800109863' WHERE (`guid` = '900021');
UPDATE `gameobject` SET `position_x` = '4066.65722656250', `position_y` = '-1233.34204101562500', `position_z` = '282.075439453125000', `orientation` = '1.448621988296508789', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.662619590759277343', `rotation3` = '0.748956084251403808' WHERE (`guid` = '900031');
UPDATE `gameobject` SET `position_x` = '4866.67773437500', `position_y` = '-600.013000488281250', `position_z` = '307.548309326171875', `orientation` = '0.645771682262420654', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.317304611206054687', `rotation3` = '0.948323667049407958' WHERE (`guid` = '900039');
UPDATE `gameobject` SET `position_x` = '4866.69042968750', `position_y` = '-600.011047363281250', `position_z` = '307.548034667968750', `orientation` = '0.645771682262420654', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.317304611206054687', `rotation3` = '0.948323667049407958' WHERE (`guid` = '900028');
UPDATE `gameobject` SET `position_x` = '6233.33984375000', `position_y` = '-1533.33483886718750', `position_z` = '441.795562744140625', `orientation` = '0.000000000000000000', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.000000000000000000', `rotation3` = '1.000000000000000000' WHERE (`guid` = '900022');
UPDATE `gameobject` SET `position_x` = '6233.32861328125', `position_y` = '-1533.31506347656250', `position_z` = '441.791992187500000', `orientation` = '4.729844093322753906', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.70090866088867187', `rotation3` = '0.713251054286956787' WHERE (`guid` = '900033');
UPDATE `gameobject` SET `position_x` = '6866.65966796875', `position_y` = '-1566.67102050781250', `position_z` = '496.311523437500000', `orientation` = '5.044002056121826171', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.58070278167724609', `rotation3` = '0.814115643501281738' WHERE (`guid` = '900023');
UPDATE `gameobject` SET `position_x` = '6866.66650390625', `position_y` = '-1566.66918945312500', `position_z` = '496.313140869140625', `orientation` = '4.782202720642089843', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.68199825286865234', `rotation3` = '0.731353819370269775' WHERE (`guid` = '900036');
UPDATE `gameobject` SET `position_x` = '6366.67919921875', `position_y` = '-1666.64697265625000', `position_z` = '480.264648437500000', `orientation` = '5.148722648620605468', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.53729915618896484', `rotation3` = '0.843391716480255126' WHERE (`guid` = '900024');
UPDATE `gameobject` SET `position_x` = '6366.67431640625', `position_y` = '-1666.66174316406250', `position_z` = '480.266937255859375', `orientation` = '3.455755710601806640', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.98768806457519531', `rotation3` = '0.156436234712600708' WHERE (`guid` = '900037');
UPDATE `gameobject` SET `position_x` = '6433.31884765625', `position_y` = '-966.676757812500000', `position_z` = '422.407806396484375', `orientation` = '5.235987663269042968', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.50000000000000000', `rotation3` = '0.866025388240814208' WHERE (`guid` = '900038');
UPDATE `gameobject` SET `position_x` = '6433.33007812500', `position_y` = '-966.664733886718750', `position_z` = '422.408020019531250', `orientation` = '2.059488296508789062', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.857167243957519531', `rotation3` = '0.515038192272186279' WHERE (`guid` = '900025');
UPDATE `gameobject` SET `position_x` = '6292.07128906250', `position_y` = '-588.729797363281250', `position_z` = '467.669281005859375', `orientation` = '1.099556446075439453', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.522498130798339843', `rotation3` = '0.852640450000762939' WHERE (`guid` = '900026');
UPDATE `gameobject` SET `position_x` = '6292.06103515625', `position_y` = '-588.716308593750000', `position_z` = '467.672027587890625', `orientation` = '4.799657344818115234', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.67558956146240234', `rotation3` = '0.737277925014495849' WHERE (`guid` = '900034');
UPDATE `gameobject` SET `position_x` = '5266.67529296875', `position_y` = '-333.334259033203125', `position_z` = '325.470855712890625', `orientation` = '5.585053920745849609', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.34202003479003906', `rotation3` = '0.939692676067352294' WHERE (`guid` = '900035');
UPDATE `gameobject` SET `position_x` = '5266.67041015625', `position_y` = '-333.331695556640625', `position_z` = '325.469177246093750', `orientation` = '2.234017848968505859', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.898793220520019531', `rotation3` = '0.438372820615768432' WHERE (`guid` = '900027');
UPDATE `gameobject` SET `position_x` = '5533.31738281250', `position_y` = '-933.350158691406250', `position_z` = '376.882934570312500', `orientation` = '1.221729278564453125', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.573575973510742187', `rotation3` = '0.819152355194091796' WHERE (`guid` = '900030');
UPDATE `gameobject` SET `position_x` = '5533.31933593750', `position_y` = '-933.326965332031250', `position_z` = '376.885650634765625', `orientation` = '1.308995485305786132', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.608760833740234375', `rotation3` = '0.793353796005249023' WHERE (`guid` = '900032');
UPDATE `gameobject` SET `position_x` = '4757.85644531250', `position_y` = '-460.462249755859375', `position_z` = '337.850799560546875', `orientation` = '3.612837791442871093', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '-0.97236919403076171', `rotation3` = '0.233448356389999389' WHERE (`guid` = '900040');
UPDATE `gameobject` SET `position_x` = '4757.87304687500', `position_y` = '-460.485687255859375', `position_z` = '337.842712402343750', `orientation` = '0.226892471313476562', `rotation0` = '0.0', `rotation1` = '0.0', `rotation2` = '0.113203048706054687', `rotation3` = '0.993571877479553222' WHERE (`guid` = '900029');

-- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DELETE FROM `gameobject_questrelation` where `id` IN (164886,171939,171942,174594,174595,174596,174597,174598,174712,174713,
164882,171940,171943,174610,174612,174613,174614,174615,174714,174715,164887,173327,174599,174600,174601,174602,174603,174604,
174708,174709,164884,174711,173326,174619,174620,174616,174617,174618,174621,174710,173324,164885,174684,174608,174609,164881,
173325,174685,164888,173284,174605,174606,174607,174686,164883,174622,174623,174624,174625,174687);
