...
(2000003320,'%s listens as $N tells him of $ghis:her; adventures in the Badlands.',0,2,0,0,NULL, 1495),
(2000003321,'Astounding!  So then indurium is the key!',0,0,0,1,NULL, 1496);
