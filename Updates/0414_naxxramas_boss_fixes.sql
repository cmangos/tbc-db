-- Highlord Mograine
UPDATE creature_template SET Leash=90, SpeedRun=1.71429, Detection=80 WHERE entry=16062;
-- Sir Zeliek
UPDATE creature_template SET Leash=90, SpeedRun=1.71429, Detection=80 WHERE entry=16063;
-- Thane Korth'azz
UPDATE creature_template SET Leash=90, SpeedRun=1.71429, Detection=80 WHERE entry=16064;
-- Lady Blaumeux
UPDATE creature_template SET Leash=90, SpeedRun=1.71429, Detection=80 WHERE entry=16065;
-- Kel'Thuzad
