...
(2000002000,'Hehehe! Things go boom!',0,0,0,0,NULL), -- 2000000318
...
DELETE FROM gameobject WHERE guid = 20 AND `id` = 144065;
INSERT INTO `gameobject` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecsmin`, `spawntimesecsmax`, `animprogress`, `state`) VALUES
(20, 144065, 1, 1, -6266.46, -3845.4, -58.7498, 0.550892, 0, 0, 0.271976, 0.962304, -5, -5, 255, 1);

-- Align
DELETE FROM dbscript_string WHERE entry = 2000000318; -- free
...
(2000000318, 'Here\'s a beacon, $N. Keep it to yourself, if you\'re gonna find mutilated things that we need.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL);
...
(2208, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2000000318, 0, 0, 0, 0, 0, 0, 0, 0, '');
