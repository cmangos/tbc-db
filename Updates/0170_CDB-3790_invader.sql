DELETE FROM `pool_creature` WHERE `pool_entry` IN (
-- MC - Firelord / Lava Annihilator
25593,25594,25595,25596,25597,25598,25599,25600,25601,25602,25603,25604,25605,25606,25607,25608,25609,25610,25622,25623,25587,

-- Silithid Hive Drone / Silithid Invader
...
-- guids already reused!
-- 151089, -- MC - Firelord / Lava Annihilator
-- 151058, -- MC - Firelord / Lava Annihilator
-- 151059, -- MC - Firelord / Lava Annihilator
-- 151060, -- MC - Firelord / Lava Annihilator
-- 151061, -- MC - Firelord / Lava Annihilator
-- 151062, -- MC - Firelord / Lava Annihilator
-- 151063, -- MC - Firelord / Lava Annihilator
-- 151064, -- MC - Firelord / Lava Annihilator
-- 151065, -- MC - Firelord / Lava Annihilator
-- 151066, -- MC - Firelord / Lava Annihilator
-- 151067, -- MC - Firelord / Lava Annihilator
-- 151068, -- MC - Firelord / Lava Annihilator
-- 151069, -- MC - Firelord / Lava Annihilator
-- 151070, -- MC - Firelord / Lava Annihilator
-- 151071, -- MC - Firelord / Lava Annihilator
-- 151072, -- MC - Firelord / Lava Annihilator
-- 151073, -- MC - Firelord / Lava Annihilator
-- 151074, -- MC - Firelord / Lava Annihilator
-- 151075, -- MC - Firelord / Lava Annihilator
-- 151087, -- MC - Firelord / Lava Annihilator
-- 151088, -- MC - Firelord / Lava Annihilator
...
DELETE FROM `creature` WHERE (`guid` = '160487');
DELETE FROM `creature` WHERE (`guid` = '160488');
DELETE FROM `creature` WHERE (`guid` = '160489');
DELETE FROM `creature` WHERE (`guid` = '160490');
DELETE FROM `creature` WHERE (`guid` = '160491');
DELETE FROM `creature` WHERE (`guid` = '160492');
DELETE FROM `creature` WHERE (`guid` = '160493');
DELETE FROM `creature` WHERE (`guid` = '160494'); -- manually added, does not seem to exist?
DELETE FROM `creature` WHERE (`guid` = '160495'); -- manually added, does not seem to exist?
DELETE FROM `creature` WHERE (`guid` = '160496'); -- manually added, does not seem to exist?
