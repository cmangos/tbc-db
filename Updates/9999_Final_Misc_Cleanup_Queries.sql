...
(1, 50600, 1, 0, -50600, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 20 (Scrolls I)) - (NPC Levels 10-25)NPC LOOT (White World Drop) - (Item Levels: 20 (Scrolls I)) - (NPC Levels 10-25)'),
(1, 50601, 1, 0, -50601, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 35 (Scrolls II)) - (NPC Levels 25-40)NPC LOOT (White World Drop) - (Item Levels: 35 (Scrolls II)) - (NPC Levels 25-40)'),
(1, 50602, 1, 0, -50602, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 50 (Scrolls III)) - (NPC Levels 40-55)NPC LOOT (White World Drop) - (Item Levels: 50 (Scrolls III)) - (NPC Levels 40-55)'),
(1, 50603, 1, 0, -50603, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 65 (Scrolls IV)) - (NPC Levels 55-62)NPC LOOT (White World Drop) - (Item Levels: 65 (Scrolls IV)) - (NPC Levels 55-62)'),
(1, 50604, 1, 0, -50604, 1, 0, 'Scrolls V - (NPC Levels 58-72) - TBC'),
(1, 60000, 1, 0, -60000, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 1-5) - (NPC Levels: 1-5)NPC LOOT (Grey World Drop) - (Item Levels: 1-5) - (NPC Levels: 1-5)'),
(1, 60001, 1, 0, -60001, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 6-10) - (NPC Levels: 6-10)NPC LOOT (Grey World Drop) - (Item Levels: 6-10) - (NPC Levels: 6-10)'),
(1, 60002, 1, 0, -60002, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 11-15) - (NPC Levels: 11-15)NPC LOOT (Grey World Drop) - (Item Levels: 11-15) - (NPC Levels: 11-15)'),
(1, 60003, 1, 0, -60003, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 16-20) - (NPC Levels: 16-20)NPC LOOT (Grey World Drop) - (Item Levels: 16-20) - (NPC Levels: 16-20)'),
(1, 60004, 1, 0, -60004, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 21-25) - (NPC Levels: 21-25)NPC LOOT (Grey World Drop) - (Item Levels: 21-25) - (NPC Levels: 21-25)'),
(1, 60005, 1, 0, -60005, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)'),
(1, 60006, 1, 0, -60006, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 31-40) - (NPC Levels: 31-40)NPC LOOT (Grey World Drop) - (Item Levels: 31-40) - (NPC Levels: 31-40)'),
(1, 60007, 1, 0, -60007, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 41-50) - (NPC Levels: 41-50)NPC LOOT (Grey World Drop) - (Item Levels: 41-50) - (NPC Levels: 41-50)'),
(1, 60008, 1, 0, -60008, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 51-60) - (NPC Levels: 51-60) - VANILLA NPC ONLYNPC LOOT (Grey World Drop) - (Item Levels: 51-60) - (NPC Levels: 51-60) - VANILLA NPC ONLY'),
...
(1, 60200, 1, 0, -60200, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 20) - (NPC Levels: 20)NPC LOOT (Blue World Drop) - (Item Levels: 20) - (NPC Levels: 20)'),
(1, 60201, 1, 0, -60201, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 20-21)NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 20-21)'),
(1, 60202, 1, 0, -60202, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 21)NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 21)'),
(1, 60203, 1, 0, -60203, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 21-22)NPC LOOT (Blue World Drop) - (Item Levels: 20-23) - (NPC Levels: 21-22)'),
...
(1, 60277, 1, 0, -60277, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60278, 1, 0, -60278, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60279, 1, 0, -60279, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60280, 1, 0, -60280, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60281, 1, 0, -60281, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60282, 1, 0, -60282, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60283, 1, 0, -60283, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60284, 1, 0, -60284, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 58) - VANILLA NPC ONLY'),
...
(1, 60325, 1, 0, -60325, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 51-54) - (NPC Levels: 52-53)NPC LOOT (Purple World Drop) - (Item Levels: 51-54) - (NPC Levels: 52-53)'),
(1, 60326, 1, 0, -60326, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 52-54) - (NPC Levels: 53)NPC LOOT (Purple World Drop) - (Item Levels: 52-54) - (NPC Levels: 53)'),
(1, 60327, 1, 0, -60327, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 52-55) - (NPC Levels: 53-54)NPC LOOT (Purple World Drop) - (Item Levels: 52-55) - (NPC Levels: 53-54)'),
(1, 60328, 1, 0, -60328, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 53-55) - (NPC Levels: 54)NPC LOOT (Purple World Drop) - (Item Levels: 53-55) - (NPC Levels: 54)'),
(1, 60329, 1, 0, -60329, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 53-56) - (NPC Levels: 54-55)NPC LOOT (Purple World Drop) - (Item Levels: 53-56) - (NPC Levels: 54-55)'),
(1, 60330, 1, 0, -60330, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 54-56) - (NPC Levels: 55)NPC LOOT (Purple World Drop) - (Item Levels: 54-56) - (NPC Levels: 55)'),
(1, 60331, 1, 0, -60331, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 54-57) - (NPC Levels: 55-56)NPC LOOT (Purple World Drop) - (Item Levels: 54-57) - (NPC Levels: 55-56)'),
(1, 60332, 1, 0, -60332, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 55-57) - (NPC Levels: 56)NPC LOOT (Purple World Drop) - (Item Levels: 55-57) - (NPC Levels: 56)'),
(1, 60333, 1, 0, -60333, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 55-58) - (NPC Levels: 56-57)NPC LOOT (Purple World Drop) - (Item Levels: 55-58) - (NPC Levels: 56-57)'),
(1, 60334, 1, 0, -60334, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 56-58) - (NPC Levels: 57)NPC LOOT (Purple World Drop) - (Item Levels: 56-58) - (NPC Levels: 57)'),
(1, 60335, 1, 0, -60335, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 56-59) - (NPC Levels: 57-58) - VANILLA NPC ONLYNPC LOOT (Purple World Drop) - (Item Levels: 56-59) - (NPC Levels: 57-58) - VANILLA NPC ONLY'),
(1, 60336, 1, 0, -60336, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 57-59) - (NPC Levels: 58) - VANILLA NPC ONLYNPC LOOT (Purple World Drop) - (Item Levels: 57-59) - (NPC Levels: 58) - VANILLA NPC ONLY'),
(1, 60337, 1, 0, -60337, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 57-60) - (NPC Levels: 58-59) - VANILLA NPC ONLYNPC LOOT (Purple World Drop) - (Item Levels: 57-60) - (NPC Levels: 58-59) - VANILLA NPC ONLY'),
(1, 60338, 1, 0, -60338, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 58-60) - (NPC Levels: 59 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60339, 1, 0, -60339, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 58-61) - (NPC Levels: 59-60 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60340, 1, 0, -60340, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 59-61) - (NPC Levels: 60 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60341, 1, 0, -60341, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 59-62) - (NPC Levels: 60-61 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60342, 1, 0, -60342, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 60-62) - (NPC Levels: 61 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60343, 1, 0, -60343, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 60-64) - (NPC Levels: 61-62 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60344, 1, 0, -60344, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 61-65) - (NPC Levels: 62-63 RAID ONLY) - VANILLA NPC ONLY'),
(1, 60345, 1, 0, -60345, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 100) - (NPC Levels 70+) - (WORLD EPIC BOE) - TBC NPC ONLYNPC LOOT (Purple World Drop) - (Item Levels: 100) - (NPC Levels 70+) - (WORLD EPIC BOE) - TBC NPC ONLY'),
(1, 60346, 1, 0, -60346, 1, 0, 'NPC LOOT (Karazhan Zone Drop) - (Level: 70 Purple) - (Item Levels: 115) - NPC Levels 70+ (RAID EPIC BOP LOOT DROP)NPC LOOT (Karazhan Zone Drop) - (Level: 70 Purple) - (Item Levels: 115) - NPC Levels 70+ (RAID EPIC BOP LOOT DROP)'),
(1, 60400, 1, 0, -60400, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 5 Pouches Only) - (NPC Levels: 1-5)NPC LOOT (White World Drop) - (Item Levels: 5 Pouches Only) - (NPC Levels: 1-5)'),
(1, 60401, 1, 0, -60401, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-10) - (NPC Levels: 5-6)NPC LOOT (White World Drop) - (Item Levels: 7-10) - (NPC Levels: 5-6)'),
(1, 60402, 1, 0, -60402, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-10) - (NPC Levels: 6)NPC LOOT (White World Drop) - (Item Levels: 7-10) - (NPC Levels: 6)'),
(1, 60403, 1, 0, -60403, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-11) - (NPC Levels: 6-7)NPC LOOT (White World Drop) - (Item Levels: 7-11) - (NPC Levels: 6-7)'),
(1, 60404, 1, 0, -60404, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-11) - (NPC Levels: 7)NPC LOOT (White World Drop) - (Item Levels: 7-11) - (NPC Levels: 7)'),
(1, 60405, 1, 0, -60405, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 7-8)NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 7-8)'),
(1, 60406, 1, 0, -60406, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 8)NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 8)'),
(1, 60407, 1, 0, -60407, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 8-9)NPC LOOT (White World Drop) - (Item Levels: 7-12) - (NPC Levels: 8-9)'),
(1, 60408, 1, 0, -60408, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 8-12) - (NPC Levels: 9)NPC LOOT (White World Drop) - (Item Levels: 8-12) - (NPC Levels: 9)'),
...
(1, 61000, 1, 0, -61000, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 66-69) - (NPC Levels: 58-65) - TBC NPC ONLYNPC LOOT (Grey World Drop) - (Item Levels: 66-69) - (NPC Levels: 58-65) - TBC NPC ONLY'),
(1, 61001, 1, 0, -61001, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 69-72) - (NPC Levels: 66-72) - TBC NPC ONLYNPC LOOT (Grey World Drop) - (Item Levels: 69-72) - (NPC Levels: 66-72) - TBC NPC ONLY'),
