...
(2000003310,'Make sure to visit the Gizmotronic Apparatus to grab a lockpick and an E.C.A.C. You will definitely need both to complete your mission!',0,0,0,0,NULL, 3171),
(2000003311,'%s points you to the Gizmotronic Apparatus.',0,2,0,0,NULL, 3203),
(2000003312,'%s explodes, lighting the sky up in a brilliant fireworks display! It seems to be beckoning to you, rogue.',0,2,0,0,NULL, 3204);

-- Wrenix's Gizmotronic Apparatus 7166 - Real gossip (20011 - was temp)
-- UPDATE creature_template SET GossipMenuId = 524 WHERE Entry = 7166;

-- DELETE FROM gossip_menu WHERE entry IN (524,20011);
-- INSERT INTO gossip_menu (entry,text_id,script_id,condition_id) VALUES
-- (524,1041,0,0);

DELETE FROM gossip_menu_option WHERE menu_id IN(524,20011);
INSERT INTO gossip_menu_option(menu_id, id, option_icon, option_text, option_id, npc_option_npcflag, action_menu_id, action_poi_id, action_script_id, box_coded, box_money, box_text, condition_id) VALUES
(524,0,0,'Press the yellow button labeled \'Thieves\' Tools.\'',1,1,-1,0,52402,0,0,NULL,1174), -- condition 218
(524,1,0,'Press the red button labeled \'E.C.A.C.\'',1,1,-1,0,52401,0,0,NULL,1174); -- 1174	9	2381	0	0	0	0	Quest ID 2381 Taken
