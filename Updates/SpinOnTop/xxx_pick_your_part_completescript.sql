...
-- Trigger NPC should be flying for correct spell visual
UPDATE `creature_template` SET `InhabitType`='4' WHERE  `Entry`=19654;
...
-- (2175103,1,1,16,0,0,0,0,0,0,0,0,0,'Chubis - OneShotKneel',0,0,0,0), -- Sniff says he should kneel, but goblins got no kneel animation in tbc
...
(10206,0,20,0,0,0,0,0,0,0,21751,12,0,'Chubis - Set Idle Movement',0,0,0,0),
(10206,1,1,0,0,0,0,0,0,0,21751,12,0,'Chubis - ONESHOT_NONE',0,0,0,0),
(10206,1,42,0,0,0,0,0,0,0,21751,12,0,'Chubis - Set Equipment Slots',0,0,0,0),
(10206,1,20,2,1,0,0,0,0,0,21751,12,0,'Chubis - Set PathId 1',0,0,0,0),
(10206,1,0,0,0,0,2000001193,0,0,0,21751,12,0,'Chubis - Alright, let''s see what makes this tech tick!',0,0,0,0);
