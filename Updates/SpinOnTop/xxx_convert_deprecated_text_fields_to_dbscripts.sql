...
-- creature_movement textid1-5 and emotes if any
DELETE FROM `dbscripts_on_creature_movement` WHERE `id` IN(1484601,1486001,1482801,1482201,1043201,1043202,1043203,1484701,1482301,1482302,1486001,1484901,1961201,1961202,2104901,1797601,1797501,1797502,1842201,1842202,1484901,1799303,1799304,1761301,73801);
...
UPDATE `creature_movement` SET `script_id`=1486001, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=56625 AND `point`=6;
...
UPDATE `creature_movement` SET `script_id`=1961202, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=70037 AND `point`=2;
UPDATE `creature_movement` SET `script_id`=2104901, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=73921 AND `point`=1;
UPDATE `creature_movement` SET `script_id`=2104901, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=73921 AND `point`=2;
UPDATE `creature_movement` SET `script_id`=2104901, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=73921 AND `point`=3;
UPDATE `creature_movement` SET `script_id`=1797601, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=82986 AND `point`=34;
UPDATE `creature_movement` SET `script_id`=1797501, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=82987 AND `point`=3;
UPDATE `creature_movement` SET `script_id`=1797502, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=82987 AND `point`=7;
...
UPDATE `creature_movement` SET `script_id`=1484901, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=83350 AND `point`=13;
...
UPDATE `creature_movement_template` SET `script_id`=1761301, `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `entry`=17613 AND `point`=9;
...
-- This guy already had a dbscript, but still had a value in textid1 as well. 
-- However, his MovementType is 0 (he follows another npc), so maybe his waypoints should be deleted altogether?
UPDATE `creature_movement` SET `textid1`=0, `textid2`=0, `textid3`=0, `textid4`=0, `textid5`=0 WHERE `id`=87089; 
