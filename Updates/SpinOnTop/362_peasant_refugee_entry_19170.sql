...
DELETE FROM `creature` WHERE `guid` IN(68577,96670) AND `id`=19170; -- Delete duplicate and incorrect spawns
...
(1917005,0,21,1,0,0,0,0,0,0,19150,151514,16,'Orc Refugee - Set Active Object',0,0,0,0),
(1917005,1,32,0,0,0,0,0,0,0,19150,151514,16,'Orc Refugee - Resume Waypoints',0,0,0,0),
...
(1917005,11,21,1,0,0,0,0,0,0,19144,151507,16,'Maghar Refugee - Set Active Object',0,0,0,0),
(1917005,11,32,0,0,0,0,0,0,0,19144,151507,16,'Maghar Refugee - Resume Waypoints',0,0,0,0),

(1917005,135,32,0,0,0,0,0,0,0,19120,151520,16,'Broken Refugee - Resume Waypoints',0,0,0,0),

(1917005,157,32,0,0,0,0,0,0,0,19162,68558,16,'Lost one Refugee - Resume Waypoints',0,0,0,0),

(1917005,181,32,0,0,0,0,0,0,0,19120,151519,16,'Broken Refugee - Resume Waypoints',0,0,0,0),

(1917005,248,32,0,0,0,0,0,0,0,19120,151518,16,'Broken Refugee - Resume Waypoints',0,0,0,0),
...
(1917005,3349,32,0,0,0,0,0,0,0,19150,151514,16,'Orc Refugee - Resume Waypoints',0,0,0,0),
(1917005,3349,32,0,0,0,0,0,0,0,19120,151520,16,'Broken Refugee - Resume Waypoints',0,0,0,0), -- Guessed timer, creature is broken on live retail

(1917005,3355,32,0,0,0,0,0,0,0,19120,151519,16,'Broken Refugee - Resume Waypoints',0,0,0,0), -- Guessed timer, creature is broken on live retail

(1917005,3366,32,0,0,0,0,0,0,0,19144,151507,16,'Maghar Refugee - Resume Waypoints',0,0,0,0),
(1917005,3366,32,0,0,0,0,0,0,0,19120,151518,16,'Broken Refugee - Resume Waypoints',0,0,0,0), -- Guessed timer, creature is broken on live retail
