...
DELETE FROM `creature` WHERE `guid`=69109; -- Delete duplicate
UPDATE `creature` SET position_x=-1978.887, position_y=5673.554, position_z=117.6499, orientation=3.752458, `MovementType`=2 WHERE `guid`=69108;
