...
-- TBC+
DELETE FROM `reference_loot_template` WHERE `item` = 23553; -- Living Branch -> Eversong Green Keeper only
...
(15636, 23553, 15, 9, 1, 1, 0, 'Living Branch');
...
-- TBC+
15651, -- Springpaw Stalker	6	7
17216 -- Skittering Crawler	6	7
);
...
-- TBC+
17202 -- Infected Nightstalker Runt	7	8
);
...
15652, -- Elder Springpaw	8	9
17203, -- Nightstalker	8	9
17217, -- Barbed Crawler	7	9
17374 -- Greater Timberstrider	7	9
);
...
-- TBC+
16347, -- Starving Ghostclaw	9	10
17199, -- Ravager Specimen	9	10
17345 -- Brown Bear	9	10
);

REPLACE INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`)
SELECT `entry`, 60410,  5, 0, -60410, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 9-13) - (NPC Levels: 10)'
FROM `creature_template` WHERE `entry` IN (
-- TBC+
17556 -- Death Ravager	10	10
);
...
-- TBC+
16350, -- Spindleweb Spider	10	11
17525 -- Bloodmyst Hatchling 10	11
);
