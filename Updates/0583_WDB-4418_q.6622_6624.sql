...
UPDATE creature_template SET RegenerateStats=0 WHERE entry IN (12923,12924,12925,12936,12937,12938); -- already correct
DELETE FROM `creature_template_addon` WHERE `entry` IN (12923,12924,12925,12936,12937,12938); -- 0 guids
