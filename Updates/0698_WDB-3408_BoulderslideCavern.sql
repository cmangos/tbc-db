...
-- align with wotlk-db
UPDATE creature SET `position_z` = 98.0963, `orientation` = 3.52028 WHERE `guid` = 29401;
UPDATE creature SET `position_z` = 94.9328, `orientation` = 2.21569 WHERE `guid` = 29437;
UPDATE creature SET `position_z` = 102.448, `orientation` = 1.18067 WHERE `guid` = 29427;
UPDATE creature SET `position_z` = 95.4404, `orientation` = 5.66334 WHERE `guid` = 29434;
UPDATE creature SET `position_z` = 116.902, `orientation` = 1.21289 WHERE `guid` = 29414;
UPDATE creature SET `position_z` = 96.7885, `orientation` = 4.98695 WHERE `guid` = 29428;
UPDATE creature SET `position_z` = 120.454, `orientation` = 1.7119 WHERE `guid` = 29438;
UPDATE creature SET `position_z` = 88.3305, `orientation` = 1.97585 WHERE `guid` = 29429;
UPDATE creature SET `position_z` = 118.713, `orientation` = 6.17664 WHERE `guid` = 29439;
UPDATE creature SET `position_z` = 118.754, `orientation` = 0.23116 WHERE `guid` = 29412;
UPDATE creature SET `position_z` = 106.11, `orientation` = 1.89599 WHERE `guid` = 29423;
UPDATE creature SET `position_z` = 105.239, `orientation` = 0.631095 WHERE `guid` = 29398;
...
UPDATE `creature` SET `spawndist` = 0 WHERE `id` IN (11915,11917,11918) AND MovementType = 2;
