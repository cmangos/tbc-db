...
(152471,16769,530,1,0,0,-2352.868,3240.676,-3.304682,5.654867,300,300,0,0,4422,2620,0,2),
...
(152486,16769,530,1,0,0,-2339.743,3242.621,-3.227272,4.014257,300,300,0,0,4422,2620,0,2),
(152487,16769,530,1,0,0,-2350.695,3227.217,-3.227273,1.029744,300,300,0,0,4422,2620,0,2),
(152488,16769,530,1,0,0,-2325.4,3215.804,-3.292264,0.9424778,300,300,0,0,4422,2620,0,0),
(152489,16769,530,1,0,0,-2337.632,3229.243,-3.283849,2.495821,300,300,0,0,4422,2620,0,2),
...
(152487, 0, 0, 1, 16, 0, 0, NULL),
(152471, 0, 0, 1, 16, 0, 0, NULL),
(152486, 0, 0, 1, 16, 0, 0, NULL),
(152489, 0, 0, 1, 16, 0, 0, NULL);
...
-- Channelers in the center
DELETE FROM `creature_movement` WHERE `id` IN(152487,152471,152486,152489);
INSERT INTO `creature_movement` (`id`,`point`,`position_x`,`position_y`,`position_z`,`waittime`,`script_id`,`orientation`) VALUES
(152487,1,-2350.7,3227.22,-3.22727,10000,1676902,1.02974),
(152471,1,-2352.87,3240.68,-3.30468,10000,1676902,5.65487),
(152486,1,-2339.74,3242.62,-3.22727,10000,1676902,4.01426),
(152489,1,-2337.63,3229.24,-3.28385,10000,1676902,2.49582);
...
(1676902,0,31,20809,10,0,0,0,0,0,0,0,0,'Firewing Warlock - Terminate Script if c.20809 not found',0,0,0,0),
(1676902,0,34,10039,0,0,0,0,0,0,0,0,0,'Firewing Warlock - Terminate Script if already channeling s.35782',0,0,0,0),
(1676902,1,15,35782,0,0,0,0,0,0,0,0,0,'Firewing Warlock - Cast White Beam',0,0,0,0);

DELETE FROM `conditions` WHERE `condition_entry`=10039;
