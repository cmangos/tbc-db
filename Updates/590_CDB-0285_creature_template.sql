...
UPDATE `creature_template` SET `FactionAlliance` = 87, `FactionHorde` = 87 WHERE `entry` IN (2638, 14281);
UPDATE `creature_template` SET `FactionAlliance` = 108, `FactionHorde` = 108 WHERE `entry` IN (13149, 13150, 13151);
