...
UPDATE npc_vendor_template SET Slot = 1 WHERE entry IN (403) AND item = 159; -- Refreshing Spring Water
UPDATE npc_vendor_template SET Slot = 2 WHERE entry IN (403) AND item = 1179; -- Ice Cold Milk
UPDATE npc_vendor_template SET Slot = 3 WHERE entry IN (403) AND item = 1205; -- Melon Juice
UPDATE npc_vendor_template SET Slot = 4 WHERE entry IN (403) AND item = 1708; -- Sweet Nectar
UPDATE npc_vendor_template SET Slot = 5 WHERE entry IN (403) AND item = 1645; -- Moonberry Juice
UPDATE npc_vendor_template SET Slot = 6 WHERE entry IN (403) AND item = 8766; -- Morning Glory Dew
