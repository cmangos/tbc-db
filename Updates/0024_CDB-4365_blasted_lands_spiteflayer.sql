...
UPDATE `creature_template` SET `SpeedWalk` = 1.6 WHERE `entry` = 8296; -- Mojo the Twisted
UPDATE `creature_template` SET `SpeedWalk` = 1.6 WHERE `entry` = 8297; -- Magronos the Unyielding
UPDATE `creature_template` SET `SpeedWalk` = 1.11111 WHERE `entry` = 8298; -- Akubar the Seer
UPDATE `creature_template` SET `SpeedWalk` = 1 WHERE `entry` = 8301; -- Clack the Reaver
UPDATE `creature_template` SET `SpeedWalk` = 1.11111 WHERE `entry` = 8302; -- Deatheye
UPDATE `creature_template` SET `SpeedWalk` = 1 WHERE `entry` = 8303; -- Grunter
UPDATE `creature_template` SET `SpeedWalk` = 1 WHERE `entry` = 8304; -- Dreadscorn

DELETE FROM `creature` WHERE (`id` = 8299);
DELETE FROM `pool_creature_template` WHERE (`id` = 8299);
DELETE FROM `pool_template` WHERE (`entry` = 1032); -- 1032	1	Spiteflayer (8299)
