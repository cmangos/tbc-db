...
DELETE FROM dbscript_string WHERE entry IN(2000002000);
INSERT INTO dbscript_string(entry,content_default,broadcast_text_id) VALUES
(2000002000,'Here is a beacon for you, $N.  You must keep it in your possession if you are to find the corrupted items we will need.',5245);
