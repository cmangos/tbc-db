...
(257001, 0, 11986, 0, -1, 201, 0, 100, 1, 5000, 15000, 15000, 30000, 'Arathi Highlands - Boulderfist Shaman - Healing Wave on Friendly Missing 50% including self'), -- s.11986 tbc+
...
(264101, 0, 10277, 2, -1, 1, 0, 100, 0, 0, 0, 2000, 3000, 'The Hinterlands - Vilebranch Headhunter - Throw on Current'), -- s.10277 tbc+
(264101, 1, 7357, 0, -1, 1, 0, 100, 1, 8000, 16000, 30000, 40000, 'The Hinterlands - Vilebranch Headhunter - Poisonous Stab on Current'); -- s.7357 tbc+
...
(264201, 0, 9613, 2, -1, 1, 0, 100, 1, 0, 0, 0, 0, 'The Hinterlands - Vilebranch Shadowcaster - Shadow Bolt'), -- s.9613 tbc+
...
(272501, 0, 34083, 2, -1, 1, 0, 100, 1, 0, 0, 0, 0, 'Badlands - Scalding Whelp - Fireball'); -- s.34083 tbc+
...
(329601, 0, 40505, 0, -1, 1, 0, 100, 1, 5000, 15000, 6000, 18000, 'Orgrimmar - Orgrimmar Grunt - Cleave on Current'), -- s.40505 tbc+
...
(480201, 1, 11642, 0, -1, 201, 0, 100, 1, 5000, 15000, 15000, 30000, 'Ashenvale - Blackfathom Tide Priestess - Heal on Friendly Missing 50% including self'); -- s.11642 tbc+
...
(526901, 1, 11642, 0, -1, 201, 0, 100, 1, 5000, 20000, 20000, 30000, 'The Temple of Atal\'Hakkar - Blackfathom Tide Priestess - Heal on Friendly Missing 50% including self'), -- s.11642 tbc+
(526901, 2, 31976, 0, -1, 5, 0, 100, 0, 10000, 30000, 30000, 60000, 'The Temple of Atal\'Hakkar - Atal\'ai Priest - Shadow Shield - friendly missing buff'); -- s.31976 tbc+
...
UPDATE `creature_spell_list` SET `Comments` = 'Blasted Lands - Felguard Elite - Cleave on Current' WHERE `Id` = 871701 AND `SpellId` = 15284; -- s.15754 classic only
UPDATE `creature_spell_list` SET `Comments` = 'Blasted Lands - Felguard Elite - Mortal Strike on Current' WHERE `Id` = 871701 AND `SpellId` = 13737; -- comments were mixed up
