...
-- Training Dummys
(@CGUID+75, 17578, 540, 3, 508.1696, 131.2284, 2.018857, 1.22173, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+76, 17578, 540, 3, 512.5972, 119.7658, 1.994586, 0.6632251, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+77, 17578, 540, 3, 523.4672, 119.2777, 1.946144, 2.042035, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+78, 17578, 540, 3, 512.9296, 186.9605, 2.00013, 0.7679449, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+79, 17578, 540, 3, 525.0672, 176.6558, 2.016024, 2.356194, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+80, 17578, 540, 3, 512.1739, 205.3514, 2.007787, 0.6981317, 86400, 86400, 0, 0), -- Training Dummy
(@CGUID+81, 17611, 540, 3, 336.7071, -84.05206, 1.992441, 3.124139, 86400, 86400, 0, 0), -- Warchief's Portal
(@CGUID+82, 15384, 540, 3, 280.4014, -91.7462, 1.821993, 2.443461, 86400, 86400, 0, 0), -- OLDWorld Trigger (DO NOT DELETE)
(@CGUID+83, 17302, 540, 3, 149.408, -83.94183, 2.01231, 1.117011, 86400, 86400, 0, 0), -- Hellfire Military Hard Mode Timer
-- Bosses
(@CGUID+84, 17083, 540, 3, 174.0495, 269.1325, -13.05492, 1.448623, 7200, 7200, 0, 0), -- Fel Orc Convert
(@CGUID+85, 17083, 540, 3, 164.7159, 266.263, -13.1122, 1.047198, 7200, 7200, 0, 0), -- Fel Orc Convert
(@CGUID+86, 17083, 540, 3, 184.4263, 269.2937, -13.05559, 1.727876, 7200, 7200, 0, 0), -- Fel Orc Convert
(@CGUID+87, 17083, 540, 3, 194.4839, 267.0721, -13.10399, 2.181662, 7200, 7200, 0, 0), -- Fel Orc Convert
(@CGUID+88, 16807, 540, 3, 178.928, 289.487, -8.18744, 4.70166, 86400, 86400, 0, 2), -- Grand Warlock Nethekurse
(@CGUID+89, 16809, 540, 3, 375.1204, 57.5781, -7.215918, 6.178465, 86400, 86400, 0, 0), -- Warbringer O'mrogg
-- (@CGUID+90, 19523, 540, 3, 374.3786, 51.28566, 30.64389, 0.03490658, 86400, 86400, 0, 0), -- O'mrogg's Left Head
-- (@CGUID+91, 19524, 540, 3, 374.3565, 64.50481, 31.22059, 6.073746, 86400, 86400, 0, 0), -- O'mrogg's Right Head
(@CGUID+92, 16808, 540, 3, 231.25, -83.64489, 5.023408, 6.265732, 86400, 86400, 0, 0), -- Warchief Kargath Bladefist
-- (@CGUID+93, 17295, 540, 3, 151.2411, -91.0293, 2.019741, 1.570796, 86400, 86400, 0, 0), -- Korag Proudmane
-- (@CGUID+94, 17296, 540, 3, 138.8807, -84.22707, 1.992269, 0.06981317, 86400, 86400, 0, 0), -- Captain Boneshatter
-- (@CGUID+95, 17297, 540, 3, 151.0459, -77.51981, 2.021008, 4.747295, 86400, 86400, 0, 0), -- Scout Orgarr
-- (@CGUID+96, 17301, 540, 3, 152.8524, -83.63912, 2.021005, 0.06981317, 86400, 86400, 0, 0), -- Shattered Hand Executioner
...
(@CGUID+88, 0, 22800, 0, 0, 0, 2); -- Grand Warlock Nethekurse (Feast of Winter Veil - Main Event)
