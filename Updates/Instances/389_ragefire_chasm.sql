...
(182024, 1, 0, 0, 0, 0, 17830, 10, 0, 2000000317, 0, 0, 0, 0, 0, 0, 0, '');
...
DELETE FROM dbscript_string WHERE entry=2000000317;
INSERT INTO `dbscript_string` (`entry`, `content_default`, `sound`, `type`, `language`, `emote`, `comment`) VALUES
-- TBC+ only (Paladin quest - The Path of the Adept 9692)
(2000000317, 'Insolent fool! You thought to steal Zelemar''s blood? You shall pay with your own!', 0, 1, 0, 0, '');
