...
DELETE FROM spawn_group WHERE `Id` BETWEEN 3000000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 7249999;
DELETE FROM spawn_group_entry WHERE `Id` BETWEEN 3000000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 7249999;
DELETE FROM spawn_group_spawn WHERE `Guid` IN (SELECT guid FROM tmp_creature);
DELETE FROM spawn_group_formation WHERE `Id` BETWEEN 3000000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 7249999;
DELETE FROM spawn_group_linked_group WHERE `Id` BETWEEN 3000000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 7249999;
DELETE FROM waypoint_path WHERE `PathId` BETWEEN 3000000 AND 5299999 OR `PathId` BETWEEN 5310000 AND 5709999 OR `PathId` BETWEEN 5720000 AND 6089999 OR `PathId` BETWEEN 6100000 AND 7249999;
