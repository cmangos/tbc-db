...
DELETE FROM spawn_group_squad WHERE `Id` BETWEEN 700000 AND 799999 OR `Id` BETWEEN 900000 AND 999999 OR `Id` BETWEEN 1090000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
