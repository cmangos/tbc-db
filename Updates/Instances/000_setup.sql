...
CREATE TABLE tmp_creature (SELECT guid, id, map FROM creature WHERE map IN (30,33,34,36,43,47,48,70,90,109,129,189,209,229,230,249,269,289,309,329,349,389,409,429,450,469,509,529,531,532,533,534,540,542,543,544,545,546,547,548,550,552,553,554,555,556,557,558,560,564,565,568,580,585));
CREATE TABLE tmp_gameobject (SELECT guid, id, map FROM gameobject WHERE map IN (30,33,34,36,43,47,48,70,90,109,129,189,209,229,230,249,269,289,309,329,349,389,409,429,450,469,509,529,531,532,533,534,540,542,543,544,545,546,547,548,550,552,553,554,555,556,557,558,560,564,565,568,580,585));
...
DELETE FROM spawn_group WHERE `Id` BETWEEN 1090000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_entry WHERE `Id` BETWEEN 1090000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_spawn WHERE `Guid` BETWEEN 1090000 AND 5299999 OR `Guid` BETWEEN 5310000 AND 5709999 OR `Guid` BETWEEN 5720000 AND 6089999 OR `Guid` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_formation WHERE `Id` BETWEEN 1090000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_linked_group WHERE `Id` BETWEEN 1090000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM waypoint_path WHERE `PathId` BETWEEN 1090000 AND 5299999 OR `PathId` BETWEEN 5310000 AND 5709999 OR `PathId` BETWEEN 5720000 AND 6089999 OR `PathId` BETWEEN 6100000 AND 9009999;
