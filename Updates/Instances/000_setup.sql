...
DELETE FROM spawn_group WHERE `Id` BETWEEN 700000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_entry WHERE `Id` BETWEEN 700000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_spawn WHERE `Guid` BETWEEN 700000 AND 5299999 OR `Guid` BETWEEN 5310000 AND 5709999 OR `Guid` BETWEEN 5720000 AND 6089999 OR `Guid` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_formation WHERE `Id` BETWEEN 700000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
DELETE FROM spawn_group_linked_group WHERE `Id` BETWEEN 700000 AND 5299999 OR `Id` BETWEEN 5310000 AND 5709999 OR `Id` BETWEEN 5720000 AND 6089999 OR `Id` BETWEEN 6100000 AND 9009999;
