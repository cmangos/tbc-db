...
-- Bonus:
-- tobsch will remove these soon anyways
UPDATE `gameobject` SET `position_x` = 6769.06, `position_y` = -5200.93, `position_z` = 760.343, `orientation` = 1.53589, `rotation2` = 0.694658, `rotation3` = 0.71934 WHERE `guid` BETWEEN 111097 AND 111099;

DELETE FROM `pool_gameobject` WHERE `guid` BETWEEN 111124 AND 111126;
DELETE FROM `gameobject` WHERE `guid` BETWEEN 111124 AND 111126;
DELETE FROM `pool_pool` WHERE `pool_id` = 9000;
DELETE FROM `pool_template` WHERE `entry` = 9000;
