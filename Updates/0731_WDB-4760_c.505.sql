...
-- Duplicates
DELETE FROM creature_addon WHERE guid IN (10414,10453,10418); -- 10451,31838,10419
...
UPDATE creature SET position_x = -9119.432617, position_y = -2611.173828, position_z = 114.952805, spawndist = 10, MovementType = 1 WHERE guid = 16460; -- bit too close to path
