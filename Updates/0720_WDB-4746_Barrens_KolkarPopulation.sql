...
DELETE FROM creature_addon WHERE guid IN (13157);
...
UPDATE creature SET spawndist = 2, MovementType = 1 WHERE guid IN (20452,20449,20465,20461,20505,20470,20472,20475,20448,20477,20439,20225,20445,20453,20481);
