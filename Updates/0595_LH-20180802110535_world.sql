...
UPDATE `npc_vendor_template` SET `Slot` = 1 WHERE `entry` = 448 AND `item` = 4604;
UPDATE `npc_vendor_template` SET `Slot` = 2 WHERE `entry` = 448 AND `item` = 4605;
UPDATE `npc_vendor_template` SET `Slot` = 3 WHERE `entry` = 448 AND `item` = 4606;
UPDATE `npc_vendor_template` SET `Slot` = 4 WHERE `entry` = 448 AND `item` = 4607;
UPDATE `npc_vendor_template` SET `Slot` = 5 WHERE `entry` = 448 AND `item` = 4608;
UPDATE `npc_vendor_template` SET `Slot` = 6 WHERE `entry` = 448 AND `item` = 8948;
