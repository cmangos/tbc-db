...
-- https://tbc.wowhead.com/npc=5451/hazzali-swarmer#comments:id=2902609
-- https://tbc.wowhead.com/npc=5457/centipaar-swarmer#comments:id=211017
UPDATE `creature_template` SET `MinLevel` = 1, `MaxLevel` = 1, `MinLevelHealth` = 1, `MaxLevelHealth` = 1, `MinLevelMana` = 0, `MaxLevelMana` = 0, `HealthMultiplier` = 0.02, `ArmorMultiplier` = 1 WHERE `Entry` = 4196;
