...
-- Readd Loot for Temporal Parasite 10717
...
(10717, 20400, 0.01, 0, 1, 1, 6012, 'Pumpkin Bag'),
...
(6228, 60005, 5, 0, -60005, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)'), -- 60006 for classic
(6228, 60140, 2, 0, -60140, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 27-31) - (NPC Levels: 28)'), -- 60150 for classic
...
(6229, 60005, 5, 0, -60005, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)'), -- 60006 for classic
(6229, 11827, 2, 0, 1, 1, 0, 'Schematic: Lil\' Smoky'),
(6229, 60140, 3, 0, -60140, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 27-31) - (NPC Levels: 28)'), -- 60148 for classic
...
(6235, 60005, 3, 0, -60005, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)'), -- 60006 for classic
...
(7361, 60005, 3, 0, -60005, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 26-30) - (NPC Levels: 26-30)'), -- 60006 for classic
(7361, 60140, 90, 1, -60140, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 27-31) - (NPC Levels: 28)'), -- 60148 for classic
...
(7800, 60140, 100, 0, -60140, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 27-31) - (NPC Levels: 28)'), -- 60152 for classic
