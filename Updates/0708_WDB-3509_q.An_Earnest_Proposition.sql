...
-- q.10492 'An Earnest Proposition' -- Added in TBC (shaman)
-- .go c id 16013
...
UPDATE quest_template SET CompleteScript = 8905 WHERE entry = 10492; -- added in TBC
...
-- q.10493 'An Earnest Proposition' -- Added in TBC (Paladin)
...
UPDATE quest_template SET CompleteScript = 8913 WHERE entry = 10493; -- added in TBC

DELETE FROM dbscript_string WHERE entry BETWEEN 2000003325 AND 2000003327;
INSERT INTO dbscript_string (entry, content_default, sound, type, language, emote, comment, broadcast_text_id) VALUES
(2000003325,'Your fate is sealed, Deliana!  You will pay for your trespasses against Lord Valthalak!',0,0,0,0,NULL, 11879),
(2000003326,'Your fate is sealed, Mokvar!  You will pay for your trespasses against Lord Valthalak!',0,0,0,0,NULL, 11893),
(2000003327,'Begone foul creatures!  Go back to the void your master shaped you from!',0,0,0,0,NULL, 11895);
