...
REPLACE INTO `waypoint_path` (entry,point,position_x,position_y,position_z,orientation,script_id,comment) SELECT id as entry, point, position_x, position_y, position_z, 100 as orientation, script_id, comment FROM creature_movement where id = 92287;
