...
(1725901, 1, 14516, 0, 1, 0, 100, 0, 4500, 25000, 1000, 25000, "Bonechewer Hungerer - Strik - on current"),
(1725901, 2, 6713, 0, 1, 0, 100, 0, 3000, 25000, 6000, 28000, "Bonechewer Hungerer - Disarm - on current"),
(1725901, 3, 16244, 0, 2, 0, 100, 0, 1000, 19000, 10000, 20000, "Bonechewer Hungerer - Demoralizing Shout - on self"),
-- heroic
(1805301, 1, 14516, 0, 1, 0, 100, 0, 4500, 25000, 1000, 25000, "Bonechewer Hungerer - Strik - on current"),
(1805301, 2, 6713, 0, 1, 0, 100, 0, 3000, 25000, 6000, 28000, "Bonechewer Hungerer - Disarm - on current"),
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1726401, 1805401);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1726901, 1804901);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1727001, 1804801);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1745501, 1805101);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1747801, 1805001);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1751701, 1805701);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
...
DELETE FROM creature_spell_list_entry WHERE Id IN (1754001, 1805601);
REPLACE INTO `creature_spell_list_entry` (Id, Name, ChanceSupportAction, ChanceRangedAttack) VALUES
