...
-- https://github.com/cmangos/classic-db/commit/18bb650c4ad864183d737dbd662733122f723ecb
-- Sungrass
...
DELETE FROM `gameobject` WHERE `guid` IN (131170,131161,131169,131150,131158,131174,131185,62357,131186,131153,131159,131172,131184,131183,131187,131160); -- 16
DELETE FROM `pool_gameobject` WHERE `guid` IN (131170,131161,131169,131150,131158,131174,131185,62357,131186,131153,131159,131172,131184,131183,131187,131160);

-- bad nodes
DELETE FROM `gameobject` WHERE `guid` IN (131151,131152,131154,131155,131156,131157,131162,131163,131164,131165,131166,131167,131168,131171,131175,131176,131177,131178,131179,131180,131181,131182,131188);
DELETE FROM `pool_gameobject` WHERE `guid` IN (131151,131152,131154,131155,131156,131157,131162,131163,131164,131165,131166,131167,131168,131171,131175,131176,131177,131178,131179,131180,131181,131182,131188);

-- 13003	23	Master Herb Pool - Blasted Lands / 5, two node kinds remain but less then 20 nodes active for sure.
UPDATE `pool_template` SET `max_limit` = 15 WHERE `entry` = 13003; -- -16 + (-23)
