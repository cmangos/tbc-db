...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60306, -60306, 0.004, 0, 1 FROM `creature_template` WHERE `entry` IN ( -- 6 Items
...
-- 60308	NPC LOOT (Purple World Drop) - (Item Levels: 43-45) - (NPC Levels: 44)
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60308, -60308, 0.004, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
-- 60310	NPC LOOT (Purple World Drop) - (Item Levels: 44-46) - (NPC Levels: 45)
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60310, -60310, 0.004, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60322, -60322, 0.004, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
-- ==================================================================================
-- tbcmangos only fixes due to item/mincountOrRef being async (level diff and loot not being adjusted correctly - only purple refloots)
...
-- Check for Single Items in all creatures from the new refloots! - nada más (all that have items will be added as refloots)
