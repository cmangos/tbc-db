...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60206, -60206, 0.1, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60211, -60211, 0.1, 0, 1 FROM `creature_template` WHERE `entry` =
...
DELETE FROM `creature_loot_template` WHERE `entry` = 4540 AND `item` = 60228;
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
...
DELETE FROM `creature_loot_template` WHERE `entry` = 4298 AND `item` = 60232;
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60242, -60242, 0.1, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
-- 60262	NPC LOOT (Blue World Drop) - (Item Levels: 49-53) - (NPC Levels: 51)
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60262, -60262, 0.1, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
(60273, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60273, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60274, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60274, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60275, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60275, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60276, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60276, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60277, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60277, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60278, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60278, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60279, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60279, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60280, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60280, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60281, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60281, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60282, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60282, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60283, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60283, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
(60284, 23199, 0, 1, 1, 1, 0, 'Totem of the Storm'), -- Horde Player in classic only
(60284, 23203, 0, 1, 1, 1, 0, 'Libram of Fervor'); -- Alliance Player in classic only
...
-- tbc+
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 30010, -30010, 0.1, 0, 1 FROM `creature_template` WHERE `entry` IN (24818,24819); -- outside
...
UPDATE `creature_template` SET `minlevel` = 36, `maxlevel` = 37 WHERE `entry` = 4298; -- Scarlet Defender (36-36)
UPDATE `creature_template` SET `minlevel` = 34, `maxlevel` = 35 WHERE `entry` = 4540; -- Scarlet Monk (34-34)

-- av mobs need special attention... tbc+ (wotlk+ set HeroicEntry = DifficultyEntry1)
