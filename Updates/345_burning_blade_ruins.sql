...
DELETE FROM gameobject WHERE guid IN(200001,200002) AND id=182263;
...
-- Boulderfist Mystics
UPDATE `creature` SET `guid`=151325 WHERE `guid`=60070 AND `id`=17135;
UPDATE `creature` SET `guid`=151326 WHERE `guid`=60071 AND `id`=17135;
UPDATE `creature` SET `guid`=151327 WHERE `guid`=60072 AND `id`=17135;
UPDATE `creature` SET `guid`=151328 WHERE `guid`=60073 AND `id`=17135;
UPDATE `creature` SET `guid`=151329 WHERE `guid`=60074 AND `id`=17135;
UPDATE `creature` SET `guid`=151330 WHERE `guid`=60075 AND `id`=17135;
UPDATE `creature` SET `guid`=151331 WHERE `guid`=60076 AND `id`=17135;
UPDATE `creature` SET `guid`=151332 WHERE `guid`=60077 AND `id`=17135;
UPDATE `creature` SET `guid`=151333 WHERE `guid`=60078 AND `id`=17135;
UPDATE `creature` SET `guid`=151334 WHERE `guid`=60079 AND `id`=17135;
UPDATE `creature` SET `guid`=151335 WHERE `guid`=60080 AND `id`=17135;
UPDATE `creature` SET `guid`=151336 WHERE `guid`=60081 AND `id`=17135;
UPDATE `creature` SET `guid`=151337 WHERE `guid`=60082 AND `id`=17135;
UPDATE `creature` SET `guid`=151338 WHERE `guid`=60083 AND `id`=17135;
UPDATE `creature` SET `guid`=151339 WHERE `guid`=60084 AND `id`=17135;
UPDATE `creature` SET `guid`=151340 WHERE `guid`=60085 AND `id`=17135;
UPDATE `creature` SET `guid`=151341 WHERE `guid`=60086 AND `id`=17135;
UPDATE `creature` SET `guid`=151342 WHERE `guid`=60087 AND `id`=17135;
UPDATE `creature` SET `guid`=151343 WHERE `guid`=60088 AND `id`=17135;
UPDATE `creature` SET `guid`=151344 WHERE `guid`=60089 AND `id`=17135;
-- Missing spawn
DELETE FROM creature WHERE guid=151345;
INSERT INTO creature (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecsmin, spawntimesecsmax, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES 
(151345,17135,530,1,0,0,-2353.576,6196.409,49.09693,0,300,300,0,0,4572,2705,0,0);


-- Fix positions, MovementType and spawndist
UPDATE `creature` SET `position_x`=-2254.501,`position_y`=6228.208,`position_z`=43.00068,`orientation`=4.066617 WHERE `guid`=151325;
UPDATE `creature` SET `position_x`=-2258.156,`position_y`=6223.644,`position_z`=43.70845,`orientation`=0.8377581 WHERE `guid`=151326;
UPDATE `creature` SET `position_x`=-2557.923,`position_y`=6289.339,`position_z`=14.93073,`orientation`=5.044002 WHERE `guid`=151328;
UPDATE `creature` SET `position_x`=-2548.215,`position_y`=6278.791,`position_z`=14.34162,`orientation`=6.090689,`MovementType`=1,`spawndist`=15 WHERE `guid`=151329;
...
UPDATE `creature` SET `MovementType`=1,`spawndist`=15 WHERE `guid` IN(151314,151333);
UPDATE `creature` SET `MovementType`=1,`spawndist`=10 WHERE `guid` IN(151313,151344,151301,151321,151343,151307,151306,151305);
UPDATE `creature` SET `MovementType`=1,`spawndist`=2 WHERE `guid` IN(151319,151315,151320,151318,151316,151342,151341,151327,151303,151332,151309);
...
UPDATE `creature` SET `MovementType`=2 WHERE `guid` IN(151331,151330,151334,151335,151345,151338,151339,151340,151326,151325,151336,151337);
DELETE FROM `creature_movement` WHERE `id` IN(151331,151330,151334,151335,151345,151338,151339,151340,151326,151325,151336,151337);
INSERT INTO `creature_movement` (`id`,`point`,`position_x`,`position_y`,`position_z`,`waittime`,`script_id`,`orientation`) VALUES
-- 151331
(151331,1,-2541.29, 6309.98, 14.2807,1000,1713501,0.750492),
-- 151330
(151330,1,-2537.24, 6313.77, 14.0923,1000,1713501,3.89208),
-- 151334
(151334,1,-2537.2, 6159.07, 60.0224,1000,1713501,1.93731),
-- 151335
(151335,1,-2538.98, 6163.36, 60.0224,1000,1713501,5.13127),
-- 151345
(151345,1,-2353.58, 6196.41, 49.0969,1000,1713501,0),
-- 151338
(151338,1,-2346.64, 6195.92, 49.3596,1000,1713501,3.01942),
-- 151339
(151339,1,-2345.1, 6116.98, 61.4476,1000,1713501,3.01942),
-- 151340
(151340,1,-2349.18, 6117.24, 61.2811,1000,1713501,0),
-- 151326
(151326,1,-2258.16, 6223.64, 43.7085,1000,1713501,0.837758),
-- 151325
(151325,1,-2254.5, 6228.21, 43.0007,1000,1713501,4.06662),
-- 151336
(151336,1,-2483.06, 6105.18, 92.4103,1000,1713501,1.55334),
-- 151337
(151337,1,-2482.71, 6111.47, 92.1755,1000,1713501,4.62512);
