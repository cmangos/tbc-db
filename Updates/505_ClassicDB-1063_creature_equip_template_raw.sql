...
UPDATE `creature_template` SET `EquipmentTemplateId` = 3 WHERE `Entry` = 9030;
...
insert into `creature_equip_template_raw` (`entry`, `equipmodel1`, `equipmodel2`, `equipmodel3`, `equipinfo1`, `equipinfo2`, `equipinfo3`, `equipslot1`, `equipslot2`, `equipslot3`) values('3','5542','0','0','50268674','0','0','529','0','0');
