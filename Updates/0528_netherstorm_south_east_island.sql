...
DELETE FROM creature WHERE guid BETWEEN @CGUID+1 AND @CGUID+172;
...
DELETE FROM creature_movement WHERE Id BETWEEN @CGUID+1 AND @CGUID+172;
...
(@CGUID+165, 2, 2832.2244,2934.2236,113.38518, 100, 1000, 1887903),
-- Phase Hunter
(@CGUID+166, 1, 2872.51, 2880.38, 106.509, 100, 0, 0),
(@CGUID+166, 2, 2811.9316,2878.247,98.02391, 100, 1000, 1887903),
-- Phase Hunter
(@CGUID+167, 1, 2820.3, 2794.57, 83.2327, 100, 0, 0),
(@CGUID+167, 2, 2806.19,2816.1062,68.63162, 100, 1000, 1887903),
-- Phase Hunter
(@CGUID+168, 1, 2756.97, 2829.56, 97.8828, 100, 0, 0),
(@CGUID+168, 2, 2756.3486,2876.6982,101.38743, 100, 1000, 1887903),
-- Phase Hunter
