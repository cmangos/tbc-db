-- elementals
UPDATE creature_template SET SchoolImmuneMask=SchoolImmuneMask|(4) WHERE entry IN(4038,4036); -- fire
UPDATE creature_template SET SchoolImmuneMask=SchoolImmuneMask|(8) WHERE entry IN(4120,4499,4034); -- nature
UPDATE creature_template SET SchoolImmuneMask=SchoolImmuneMask|(16) WHERE entry IN(3917,6047,12876,4978,10757,10756); -- frost
