...
UPDATE `creature_template` SET `DamageMultiplier`='35', `MinMeleeDmg`='148.3', `MaxMeleeDmg`='196.6', `MinRangedDmg`='0', `MaxRangedDmg`='0', `MeleeAttackPower`='268', `RangedAttackPower`='32' WHERE `Entry`='15517';
	...
	UPDATE `creature_template` SET `UnitFlags`='33554432', `ExtraFlags`='0', `MinLevelHealth`='3052', `MaxLevelHealth`='3052', `MinMeleeDmg`='103.9', `MaxMeleeDmg`='137.9', `Armor`='3791', `MeleeAttackPower`='252', `RangedAttackPower`='26' WHERE `Entry`='15957';
...
UPDATE `creature_template` SET `MinMeleeDmg`='109.8', `MaxMeleeDmg`='145.6', `MinRangedDmg`='0', `MaxRangedDmg`='0', `MeleeAttackPower`='268', `RangedAttackPower`='32' WHERE `Entry`='15727';
	...
	UPDATE `creature_template` SET `MinLevel`='60', `MaxLevel`='60', `HealthMultiplier`='2', `ArmorMultiplier`='1', `MinLevelHealth`='6104', `MaxLevelHealth`='6104', `MinLevelMana`='0', `MaxLevelMana`='0', `MinRangedDmg`='0', `MaxRangedDmg`='0', `Armor`='3791', `MeleeAttackPower`='252', `RangedAttackPower`='26' WHERE `Entry`='15901';
...
UPDATE `creature_template` SET `DamageMultiplier`='30', `MinMeleeDmg`='107.9', `MaxMeleeDmg`='143.1', `MinRangedDmg`='0', `MaxRangedDmg`='0', `MeleeAttackPower`='262', `RangedAttackPower`='30' WHERE `Entry`='15277';
	-- Anubisath Warrior
	UPDATE `creature_template` SET `MinLevel`='61', `MaxLevel`='61', `Faction`='310', `Faction`='310', `HealthMultiplier`='12', `DamageMultiplier`='3', `ArmorMultiplier`='1', `MinMeleeDmg`='105.8', `MaxMeleeDmg`='140.3', `MinRangedDmg`='0', `MaxRangedDmg`='0', `Armor`='4091', `MeleeAttackPower`='258', `RangedAttackPower`='28' WHERE `Entry`='15537';
	-- Anubisath Swarmguard
	UPDATE `creature_template` SET `MinLevel`='61', `MaxLevel`='61', `Faction`='310', `Faction`='310', `HealthMultiplier`='2', `DamageMultiplier`='15', `ArmorMultiplier`='1', `MinMeleeDmg`='68.8', `MaxMeleeDmg`='91.2', `MinRangedDmg`='0', `MaxRangedDmg`='0', `Armor`='4091', `MeleeAttackPower`='258', `RangedAttackPower`='28' WHERE `Entry`='15538';
