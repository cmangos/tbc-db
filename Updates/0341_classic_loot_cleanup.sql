...
-- Table 'creature_loot_template' entry 12397 group 2 has total chance > 100% (200.000000)
...
UPDATE `creature_loot_template` SET `groupid` = 0 WHERE `entry` = 639 AND `mincountOrRef` IN (-50600,-50610,-60124,-60443);
