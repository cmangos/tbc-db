UPDATE creature_template SET SchoolImmuneMask=SchoolImmuneMask|(8) WHERE entry IN(9377,11577,11576,4661,11578,2735,2359); -- nature
UPDATE creature_template SET SchoolImmuneMask=SchoolImmuneMask|(16) WHERE entry IN(2776); -- frost
