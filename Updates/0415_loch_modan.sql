...
UPDATE `creature_template` SET `Scale` = 1.50, `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000 WHERE `entry` = 2476;
...
UPDATE `creature_template` SET `Faction` = 45, `UnitFlags` = 64, `SpeedWalk` = 1, `Scale` = 1.3, `RangedBaseAttackTime` = 2000, `PickpocketLootId` = 1210, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1210;
...
UPDATE `creature_template` SET `NpcFlags` = 0, `UnitFlags` = 64, `RangedBaseAttackTime` = 2000, `MovementType` = 0 WHERE `entry` = 2477;
-- https://www.wowhead.com/classic/npc=2478/haren-swifthoof
UPDATE `creature_template` SET `NpcFlags` = 0, `UnitFlags` = 64, `RangedBaseAttackTime` = 2000, `MovementType` = 0 WHERE `entry` = 2478;
-- https://www.wowhead.com/classic/npc=7170/thragomm
UPDATE `creature_template` SET `NpcFlags` = 0, `UnitFlags` = 32832, `RangedBaseAttackTime` = 2000, `DamageMultiplier` = 1.7, `MovementType` = 0 WHERE `entry` = 7170;
DELETE FROM `spawn_group` WHERE id = 3;
INSERT INTO `spawn_group` (`Id`, `Name`, `Type`, `MaxCount`, `WorldState`, `Flags`) VALUES
(3,'Loch Modan - Horde Runner Patrol (3) - 2477,2478,7170', 0, 0, 0, 2);
DELETE FROM `spawn_group_formation` WHERE id = 3;
INSERT INTO `spawn_group_formation` (`Id`, `FormationType`, `FormationSpread`, `FormationOptions`, `PathId`, `MovementType`, `Comment`) VALUES
(3, 3, 3, 0, 3, 2, 'Loch Modan - Horde Runner Patrol (3) - 2477,2478,7170');
DELETE FROM `spawn_group_spawn` WHERE id = 3;
INSERT INTO `spawn_group_spawn` (`Id`, `Guid`, `SlotId`) VALUES
(3, 9203, 0),
(3, 9204, 1),
(3, 9205, 2);
REPLACE INTO `waypoint_path_name` (`PathId`, `Name`) VALUES (3, 'Loch Modan - Horde Runner Patrol (3) - 2477,2478,7170');
...
DELETE FROM `waypoint_path` WHERE `PathId` = 3;
INSERT INTO `waypoint_path` (`PathId`, `Point`, `PositionX`, `PositionY`, `PositionZ`, `Orientation`, `WaitTime`, `ScriptId`, `Comment`) VALUES
(3, 1, -5715, -3532.59, 304.363, 100, 0, 0, NULL), -- wotlkdb data
(3, 2, -5708.71, -3539.77, 304.927, 100, 0, 0, NULL),
(3, 3, -5696.26, -3549.28, 305.553, 100, 0, 0, NULL),
(3, 4, -5696.04, -3563.09, 307.879, 100, 0, 0, NULL),
(3, 5, -5683.63, -3578.94, 309.475, 100, 0, 0, NULL),
(3, 6, -5673.26, -3598.36, 311.779, 100, 0, 0, NULL),
(3, 7, -5668.69, -3618.71, 311.241, 100, 0, 0, NULL),
(3, 8, -5656.84, -3631.12, 313.19, 100, 0, 0, NULL),
(3, 9, -5637.64, -3647.74, 313.295, 100, 0, 0, NULL),
(3, 10, -5628.38, -3653.29, 315.804, 100, 0, 0, NULL),
(3, 130, -5697.93, -3542.56, 305.626, 100, 0, 0, NULL),
(3, 131, -5714.33, -3524.31, 303.827, 100, 0, 0, NULL);
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 3000, `PickpocketLootId` = 1180, `MovementType` = 0, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1180;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000, `PickpocketLootId` = 1183, `MovementType` = 0, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1183;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000, `MovementType` = 0, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1179;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1178;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000, `MovementType` = 0, `ExtraFlags` = `ExtraFlags`|1048576 WHERE `entry` = 1181;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000 WHERE `entry` = 1167;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000 WHERE `entry` = 1165;
...
UPDATE `creature_template` SET `UnitFlags` = 32768, `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000, `PickpocketLootId` = 1222, `ResistanceArcane` = 0 WHERE `entry` = 1222;
...
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000 WHERE `entry` = 1207;

-- https://www.wowhead.com/classic/npc=1206/gnasher
UPDATE `creature_template` SET `SpeedWalk` = 1, `RangedBaseAttackTime` = 2000 WHERE `entry` = 1206;
...
UPDATE `creature_template` SET `MinLevel` = 14, `MaxLevel` = 14, `RangedBaseAttackTime` = 2000 WHERE `entry` = 1177;
...
UPDATE `creature_template` SET `RangedBaseAttackTime` = 2000 WHERE `entry` = 1175;
...
UPDATE `creature_template` SET `RangedBaseAttackTime` = 2000 WHERE `entry` = 1176;
...
UPDATE `creature_template` SET `RangedBaseAttackTime` = 2000 WHERE `entry` = 1202;
...
-- tbc+
UPDATE `creature` SET `spawntimesecsmin` = 300 WHERE `id` = 1210; -- faster respawn
-- 2008-01-27 08-06-38_MUUGI.sqlite_parsed
-- aligning data with wotlk-db
UPDATE `creature_template` SET `Scale` = 1.3 WHERE `entry` = 1210;
UPDATE `creature_template` SET `Scale` = 1.5 WHERE `entry` = 14267; -- 0.85
UPDATE `creature_template` SET `Scale` = 1.1 WHERE `entry` = 1178;
UPDATE `creature_template` SET `Scale` = 1.40 WHERE `entry` = 1179; -- 0.85
UPDATE `creature_template` SET `Scale` = 1.15 WHERE `entry` = 1180;
UPDATE `creature_template` SET `Scale` = 1.30 WHERE `entry` = 1181; -- 1
