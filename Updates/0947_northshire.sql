...
-- tbc+
15644,15649,15650,15651,15652,16347,16350,16353,16516,16517,16518,16520,16521,16522,16537,17199,17200,17201,17202,17203,17216,17217,17345,17349,17372,17373,17374,17525);

-- Slightly increased ChanceOrQuestChance for some mobs
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 0.66 WHERE `mincountOrRef` = -60441 AND `entry` IN (6,80,257,6866,1124,808,724,1199,707,1718,1533,1890,1918,1501,1918,1935,2013,6911,3281,15635,16855,15636,15656,16537,17298);
...
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 0.75 WHERE `mincountOrRef` = -60441 AND `entry` IN (199,481,834,1172,1173,1530,1532,1539,1540,1769,2014,2030,2176,2189,2965,3118,3131,3198,3199,3267,3268,3379,119,1765,2034,2070,2234,3110,3199,3227,16350,17525,2973,3225,3226);
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 0.25 WHERE `mincountOrRef` = -60442 AND `entry` IN (199,481,834,1172,1173,1530,1532,1539,1540,1769,2014,2030,2176,2189,2965,3118,3131,3198,3199,3267,3268,3379,119,1765,2034,2070,2234,3110,3199,3227,16350,17525,2973,3225,3226);
