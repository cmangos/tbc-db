--  Westfall - Skeletal Miner | Undead Excavator | Undead Dynamiter | Foreman Thistlenettle
-- https://github.com/cmangos/classic-db/commit/99023dbfed7d77fa8f6a03940e73d4da83ceda36
-- https://github.com/cmangos/classic-db/commit/d80dba5744c52612a596db5f59fbffdbff4bab72

-- diff again as classic now moved to this range. https://github.com/cmangos/tbc-db/commit/a254ee66d8240aef181b0c305e25c41948dd83a6

-- SELECT * FROM creature where guid BETWEEN 140000 AND 140100; -- DIFF with classicmangos
-- use vmangos guids this time as these spawns are still missing in other cmangos projects to due lack of backporting and at this point they will just be reworked in a more complete fashion and then ported to tbc again.
DELETE FROM `creature` WHERE `id` IN (11447,11497,11498);
INSERT INTO `creature` (`guid`, `id`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES
(300846, 11447, 1, -3760.81, 1093.55, 132.094, 0, 21600, 25200, 30, 1), -- 45758/140001
(300848, 11497, 1, -3760.81, 1093.55, 132.094, 0, 21600, 25200, 30, 1), -- 45759/140002
(300847, 11498, 1, -3760.81, 1093.55, 132.094, 0, 21600, 25200, 30, 1); -- 45760/140003

-- https://github.com/cmangos/tbc-db/blob/71c5c93496ed4af7d89ca10f1f5c1a500ce5a2df/Updates/0736_WDB-4767_q.10998.sql#L5

SET @CGUID := 140000;
-- 96	Blasted Lands - Felguard Elite (3) Patrol 001
SET @SGUID := 97;

DELETE FROM `creature_movement` WHERE (`id` IN (89571, 89989));
DELETE FROM `creature` WHERE (`guid` IN (89564, 89565, 89566, 89567, 89568, 89569, 89570, 89571, 89572, 89989, 89990, 89991, 89992, 89993, 89994, 89995, 89996, 90124, 90125, 90364, 90366)); -- SELECT * FROM creature where id IN (623,624,625,626) order by id,guid;
