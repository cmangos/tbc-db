...
-- Update templates
UPDATE creature_template SET UnitFlags=256, SpeedRun=(11.5/7), MovementType=2, AIName='NullAI', ScriptName='' WHERE entry=22114; -- Huffer. NullAI so huffer doesn't fight back
