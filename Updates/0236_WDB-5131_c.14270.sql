...
DELETE FROM creature_addon WHERE guid BETWEEN 98811 AND 98840;
DELETE FROM creature_movement WHERE id BETWEEN 98811 AND 98840;
DELETE FROM game_event_creature WHERE guid BETWEEN 98811 AND 98840;
DELETE FROM game_event_creature_data WHERE guid BETWEEN 98811 AND 98840;
DELETE FROM creature_battleground WHERE guid BETWEEN 98811 AND 98840;
DELETE FROM creature_linking WHERE guid BETWEEN 98811 AND 98840
 OR master_guid BETWEEN 98811 AND 98840;
DELETE FROM creature WHERE guid BETWEEN 98811 AND 98840;
-- Removed from pools
DELETE FROM pool_creature_template WHERE id = 14270; -- 14270	1095	0	Squiddic (14270)
DELETE FROM pool_template WHERE entry = 1095; -- 1095	1	Squiddic (14270) - 1018
-- wps
