...
(36938,2186,1,1,0,0,4904.43,328.846,36.7678,6.16146,9900,0,0,356,0,0,0);

-- Only one can be spawned at at the same time
DELETE FROM pool_template WHERE entry = 25521;
INSERT INTO pool_template (entry, max_limit, description) VALUES 
(25521,1,'Carnivous the Breaker');
DELETE FROM pool_creature_template WHERE pool_entry = 25521;
INSERT INTO pool_creature_template (id, pool_entry, chance, description) VALUES
(2186, 25521, 0, 'Carnivous the Breaker - 2186');
