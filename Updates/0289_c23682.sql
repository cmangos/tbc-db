...
UPDATE `creature_template` SET `ExtraFlags` = `ExtraFlags`|4194304, `MechanicImmuneMask` = `MechanicImmuneMask`|1+4+8+256+512+131072+33554432+536870912, `MechanicImmuneMask` = `MechanicImmuneMask`&~2048 WHERE `entry` = 23775;
