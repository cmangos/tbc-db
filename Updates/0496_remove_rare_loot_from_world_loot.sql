...
DELETE FROM reference_loot_template WHERE `item` IN (31256,31263,31264) AND `entry` != 65276;
DELETE FROM `creature_loot_template` WHERE `item` = 31264; -- https://www.wowhead.com/item=31264/silvermoon-robes#dropped-by Sunhawk Agent
INSERT INTO creature_loot_template (entry, item, ChanceOrQuestChance, groupid, mincountOrRef, maxcount, condition_id, comments) VALUES ('17610', '31264', '0.01', '0', '1', '1', '0', 'Silvermoon Robes');

-- 65277	NPC LOOT (Rare NPC Loot) - Dr. Whitherlimb - Special Items
DELETE FROM reference_loot_template WHERE `item` IN (31268,31269,31270) AND `entry` != 65277;
DELETE FROM `creature_loot_template` WHERE `item` = 31270; -- https://www.wowhead.com/item=31270/banshee-rod#dropped-by Deatholme Darkmage
INSERT INTO creature_loot_template (entry, item, ChanceOrQuestChance, groupid, mincountOrRef, maxcount, condition_id, comments) VALUES ('16318', '31270', '0.01', '0', '1', '1', '0', 'Silvermoon Robes');
