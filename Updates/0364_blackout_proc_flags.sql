...
UPDATE spell_proc_event SET SpellFamilyMask0=(8192+32768+524288+8388608+33554432+8589934592+4398046511104) WHERE entry=15268; -- |(0x0000000000800000 + 0x0000040000000000) Now 4406678953984

-- 0x80000 (524288) = Touch of Weakness (Procced Damage Spell) - only mask missing in classicmangos is 524288, mana burn was wrong in classicmangos
-- Mind Flay (this commit, 0x0000000000800000 (8388608)), Vampiric Touch (0x0000040000000000 (4398046511104) nonexistant in classic)
...
-- classic: https://wowpedia.fandom.com/wiki/Blackout?direction=next&oldid=282365 (still no Feedback or Mana Burn)

-- Current tbcmask is 4406746062848 (4398046511104+8589934592+67108864,33554432,8388608,524288,32768,8192)
