...
DELETE FROM gossip_menu_option WHERE menu_id IN (10598,10614);
DELETE FROM gossip_menu WHERE entry IN (10614);
DELETE FROM creature_template_addon WHERE entry=16509;
