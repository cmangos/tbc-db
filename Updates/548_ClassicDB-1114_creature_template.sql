...
UPDATE `creature_template` SET `MinLevel`='48', `MaxLevel`='48', `FactionAlliance`='16', `FactionHorde`='16', `UnitFlags`='64', `SpeedWalk`='1', `MeleeBaseAttackTime`='2000', `RangedBaseAttackTime`='2000' WHERE `Entry`='5347';
