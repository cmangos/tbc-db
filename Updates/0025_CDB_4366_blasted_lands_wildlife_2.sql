-- 3932, 3936 already removed.	
DELETE FROM `creature` WHERE (`guid` IN (3911, 3937, 3939, 3940, 3941, 3942, 3943, 3944)); -- there should be 15 spawns in TBC+

SET @CGUID := 140310;
SET @SGUID := 268;

DELETE FROM `creature` WHERE `guid` BETWEEN @CGUID AND @CGUID + 012;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES
(@CGUID + 000, 0, 0, 1, -11183.5703125000, -3348.032226562500, 8.228083610534667968, 1.326243877410888671, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 000 - 3942
(@CGUID + 001, 0, 0, 1, -11186.9052734375, -3282.049804687500, 8.313661575317382812, 2.164485454559326171, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 001 - 3943
(@CGUID + 002, 0, 0, 1, -11150.5908203125, -3315.790283203125, 4.748173713684082031, 2.364883899688720703, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 002 - 3939
(@CGUID + 003, 0, 0, 1, -11213.4003906250, -3313.360351562500, 8.598316192626953125, 5.308971405029296875, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 003 - 3940
(@CGUID + 004, 0, 0, 1, -11247.1171875000, -3289.826904296875, 25.29104232788085937, 5.709574222564697265, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 004 - 3944
(@CGUID + 005, 0, 0, 1, -11250.0576171875, -3148.635986328125, 3.736725330352783203, 5.460514545440673828, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 005 - missing
(@CGUID + 006, 0, 0, 1, -11184.6845703125, -3216.660156250000, 9.319871902465820312, 3.200205326080322265, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 006 - 3941 spawns midair
(@CGUID + 007, 0, 0, 1, -11217.0703125000, -3182.307861328125, 8.219674110412597656, 1.753100991249084472, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 007 - 3911 spawns inside tree
(@CGUID + 008, 0, 0, 1, -11251.3134765625, -3083.353027343750, 3.612272262573242187, 3.967054367065429687, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 008 - 3937
(@CGUID + 009, 0, 0, 1, -11216.6201171875, -3117.091552734375, 4.671710491180419921, 4.392993450164794921, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 009 - or 3937
(@CGUID + 010, 0, 0, 1, -11282.8662109375, -3115.085205078125, 3.991223335266113281, 0.944668114185333251, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 010 - missing
(@CGUID + 011, 0, 0, 1, -11314.9101562500, -3147.677246093750, 5.831459522247314453, 4.251431465148925781, 300, 300, 45, 1), -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 011 - missing
(@CGUID + 012, 0, 0, 1, -11348.6835937500, -3182.680175781250, 10.31614112854003906, 3.896257877349853515, 300, 300, 45, 1); -- Blasted Lands - Redstone Basilisk | Ashmane Boar(1) Wandering 012 - missing
-- + 3 tbc+
...
-- TBC+
(256, 5990, 0, 0, 0), (256, 5992, 0, 0, 0),
(257, 5990, 0, 0, 0), (257, 5992, 0, 0, 0),
(280, 5990, 0, 0, 0), (280, 5992, 0, 0, 0);
