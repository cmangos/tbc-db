...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60136, -60136, 2, 0, 1 FROM `creature_template` WHERE `entry` =
...
DELETE FROM `creature_loot_template` WHERE `entry` = 4540 AND `item` = 60152;
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60153, -60153, 5, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60157, -60157, 5, 0, 1 FROM `creature_template` WHERE `entry` = 7351; -- Tomb Reaver (37-37) - 36-37 tbc+ - https://web.archive.org/web/20071105011453/http://wow.allakhazam.com/db/mob.html?wmob=7351
DELETE FROM `creature_loot_template` WHERE `entry` = 4298 AND `item` = 60156;
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60157, -60157, 5, 0, 1 FROM `creature_template` WHERE `entry` = 4298; -- 36-37 tbc+ https://www.wowhead.com/classic/npc=4298
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60159, -60159, 5, 0, 1 FROM `creature_template` WHERE `entry` = 4861; -- Shrike Bat (38-39) -- 37-38 tbc+ - https://web.archive.org/web/20071217035030/http://wow.allakhazam.com/db/mob.html?wmob=4861
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60159, -60159, 5, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60166, -60166, 100, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60169, -60169, 5, 0, 1 FROM `creature_template` WHERE `entry` = 11790; -- 42-43 tbc+ https://web.archive.org/web/20080106091355/http://wow.allakhazam.com/db/mob.html?wmob=11790
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60172, -60172, 2, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60172, -60172, 5, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60174, -60174, 2, 0, 1 FROM `creature_template` WHERE `entry` IN (
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60186, -60186, 2, 0, 1 FROM `creature_template` WHERE `entry` IN (
