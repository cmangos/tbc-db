...
(2000003244,'This should only take a moment, $N.',0,0,1,1,NULL, 2085),
(2000003245,'I call your true name, Azrethoc. Show your visage to me!',0,0,8,5,NULL, 2087),
(2000003246,'Pathetic Forsaken weakling. You wish to see my master? So be it.',0,0,1,0,NULL, 2089),
(2000003247,'Who dares to seek me out?!',0,0,8,0,NULL, 2090),
(2000003248,'Insects!',0,0,8,0,NULL, 2091),
(2000003249,'Come! Come to your deaths--if you dare!',0,0,8,0,NULL, 2092),
(2000003250,'Yes, come. My master and I shall be waiting.',0,0,1,0,NULL, 2093),
(2000003251,'An interesting turning of events.',0,0,1,1,NULL, 2094);

-- Jugkar Grim'rod's Image 5773
UPDATE creature_template SET UnitFlags = 33555200 WHERE entry = 5773;
-- Lord Azrethoc\'s Image 5772
UPDATE creature_template SET UnitFlags = 33555200 WHERE entry = 5772;
