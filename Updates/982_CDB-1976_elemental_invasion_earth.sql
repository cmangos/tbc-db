...
DELETE FROM game_event WHERE entry=15;
INSERT INTO game_event (entry, start_time, end_time, occurence, length, holiday, linkedTo, description) VALUES
(15, '2006-01-04 00:00:00', '2030-12-31 23:59:00', 4320, 2160, 0, 0, 'Elemental Invasion: Earth');
...
(@GUID + 1, 179664, 1, 1, 4609.79, -7151.82, 115.72, -0.523599, 0, 0, -0.258819, 0.965926, 300, 300, 0, 1),     -- Earth Elemental Rifts
(@GUID + 2, 179664, 1, 1, 4531.51, -7096.53, 102.136, -1.81514, 0, 0, -0.78801, 0.615662, 300, 300, 0, 1),
(@GUID + 3, 179664, 1, 1, 4751.65, -7079.59, 92.7444, 2.30383, 0, 0, 0.913544, 0.406739, 300, 300, 0, 1),
(@GUID + 4, 179664, 1, 1, 4515.68, -7416.42, 82.5434, -1.309, 0, 0, -0.608763, 0.793352, 300, 300, 0, 1),
(@GUID + 5, 179664, 1, 1, 4553.76, -7269.88, 112.396, -2.98451, 0, 0, -0.996917, 0.0784606, 300, 300, 0, 1);
...
(@GUID + 1, 14464, 1, 1, 0, 0, 4487.17, -7316, 93.526, 0.763415, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 14881, 0, 0, 2),
(@GUID + 2, 14462, 1, 1, 0, 0, 4475.64, -7327.93, 91.162, 0.790901, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 653, 0, 0, 0),
(@GUID + 3, 14462, 1, 1, 0, 0, 4490.45, -7329.19, 90.8456, 0.790901, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 653, 0, 0, 0),
(@GUID + 4, 14462, 1, 1, 0, 0, 4471.36, -7316.08, 93.7642, 0.790901, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 696, 0, 0, 0);
