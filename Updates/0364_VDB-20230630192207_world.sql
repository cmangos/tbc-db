...
UPDATE `gameobject` SET `id` = 0, `spawntimesecsmin` = 300, `spawntimesecsmax` = 900 WHERE `guid` = 55457; -- 443.818, 288.769, 42.4809
...
UPDATE `creature_loot_template` SET `item` = 60160, `mincountOrRef` = -60160, `comments` = 'NPC LOOT (Green World Drop) - (Item Levels: 37-41) - (NPC Levels: 38)' WHERE `entry` = 4380 AND `mincountOrRef` = -60164; -- tbc+
UPDATE `creature_loot_template` SET `item` = 60236, `mincountOrRef` = -60236, `comments` = 'NPC LOOT (Blue World Drop) - (Item Levels: 36-41) - (NPC Levels: 38)' WHERE `entry` = 4380 AND `mincountOrRef` = -60240; -- tbc+
