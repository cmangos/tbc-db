...
-- TBC 9659	Unkillable Test Dummy not used here https://github.com/cmangos/classic-db/commit/b03ae1d191528ef9100dbef293840fd736281b9f#commitcomment-31514911
...
DELETE FROM `dbscript_string` WHERE `entry` = 2000009018; -- Defend yourself, fool!
...
UPDATE creature_template SET MovementType=2 WHERE Entry=1436; -- set in creature_template as its no static spawn
...
-- Fix equipment of NPC 1000 (Watcher Hutchins)
UPDATE `creature_equip_template` SET `equipentry2` = 2081, `equipentry3` = 2551 WHERE `entry` = 1000;
