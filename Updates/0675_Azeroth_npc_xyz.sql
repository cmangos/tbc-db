...
DELETE FROM `creature` WHERE `id` = 5569; -- Fizzlebang Booms <Fireworks Vendor> - MISSING!
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES
(90283, 5569, 0, 1, -4850.698, -1295.238, 501.9512, 1.396263, 300, 300, 0, 0); -- wotlk-db guid
...
-- tbc+ updates
UPDATE `creature` SET `position_x` = -9479.25, `position_y` = 52.86898, `position_z` = 56.96745, `orientation` = 0.8203048 WHERE `guid` = 79949 AND `id` = 11940; -- Merissa Stilwell - Patch 2.4.3 (2008-07-15): Moved from Northshire Abbey to Goldshire.
UPDATE `creature` SET `position_x` = -5581.237, `position_y` = -540.9461, `position_z` = 403.6241, `orientation` = 2.286381 WHERE `guid` = 348 AND `id` = 11941; -- Yori Crackhelm - Patch 2.4.3 (2008-07-15): Moved from Anvilmar to Kharanos.
UPDATE `creature` SET `position_x` = 9839.588, `position_y` = 945.9911, `position_z` = 1307.267, `orientation` = 5.846853 WHERE `guid` = 46827 AND `id` = 11942; -- Orenthil Whisperwind - Patch 2.4.3 (2008-07-15): Moved from Shadowglen to Dolanaar.
-- TDB, not found in Sniff
UPDATE `creature` SET `position_x` = 327.574, `position_y` = -4682.93, `position_z` = 16.4578, `orientation` = 5.8253 WHERE `guid` = 3416 AND `id` = 11943; -- Magga - Patch 2.4.3 (2008-07-15):  Moved from Valley of Trials to Razor Hill.
UPDATE `creature` SET `position_x` = -2328.49, `position_y` = -382.269, `position_z` = -7.89994, `orientation` = 1.79769 WHERE `guid` = 26568 AND `id` = 11944; -- Vorn Skyseer - Patch 2.4.3 (2008-07-15): Moved from Camp Narache to Bloodhoof Village.
UPDATE `creature` SET `position_x` = 2286.34, `position_y` = 247.798, `position_z` = 41.1148, `orientation` = 3.00922 WHERE `guid` = 31923 AND `id` = 11945; -- Claire Willower - Patch 2.4.3 (2008-07-15): Moved from Deathknell to Brill.
