...
UPDATE `quest_template` SET `RewRepFaction1` = 809, `RewRepValue1` = 500 WHERE `entry` IN (7483,7484,7485); -- 200 in classic, 7483 is missing rep completely
UPDATE `quest_template` SET `RewRepFaction1` = 270, `RewRepValue1` = 500 WHERE `entry` IN (9208,9209,9210); -- 200 in classic
