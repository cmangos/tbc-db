...
UPDATE quest_template SET RequiredCondition = 0, ExclusiveGroup = 0 WHERE entry IN (2761,2762,2763); -- 0 -2761
...
UPDATE quest_template SET RequiredCondition = 3823, PrevQuestId = 0 WHERE entry = 2764; -- 2761
...
UPDATE quest_template SET PrevQuestId = 2764, ExclusiveGroup = 0, NextQuestId = 0 WHERE entry IN (2771,2772,2773); -- 2760 -2771 0
...
UPDATE quest_template SET RequiredCondition = 3827 WHERE entry = 3321; -- 0
