...
(2000003285,'%s places the scroll on the table, and reads...',0,2,0,0,NULL, 1671),
(2000003286,'By the Light!  This cursed spy was a good one!  I\'m glad he\'s dead.',0,0,7,0,NULL, 1672),
(2000003287,'Thank you for this report, $N.  It is now clear that we must tighten our patrols near Theramore.',0,0,7,0,NULL, 1673);
...
(40,21128,1,1,-3735.523,-4554.6035,28.552734,0.4712385,0,0,0.23344517,0.97236997,-20,-20,255,1);

UPDATE `gameobject_template` SET `size` = 0.3 WHERE `entry` = 21128; -- Orc Spy Report
