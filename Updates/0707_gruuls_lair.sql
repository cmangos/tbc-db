...
-- (1938901, 1, 24193, 0, 102, 0, 100, 0, 15000, 18000, 27000, 33000, "Lair Brute - Cast Charge - on random player casting"), still via creature_ai_script because of aggro wipe
(1938901, 1, 39171, 0, 1, 0, 100, 0, 5000, 10000, 8000, 12000, "Lair Brute - Mortal Strike - on current"), 
(1938901, 2, 39174, 0, 1, 0, 100, 0, 3000, 8000, 6000, 11000, "Lair Brute - Cleave - on current");
...
(2135001, 2, 36678, 0, 201, 0, 100, 0, 0, 2000, 22000, 28000, "Gronn-Priest - Heal - on missing 50% including self");
