...
DELETE FROM `conditions` WHERE `condition_entry` BETWEEN 527 AND 532;
INSERT INTO `conditions` (`condition_entry`, `type`, `value1`, `value2`) VALUES 
(527, 37, 8391, 80), -- Lathoric
(528, 37, 8421, 10), -- Dorius
(529, 37, 8400, 80), -- Obsidion
(530, -3, 529, 0), -- Obsidion NOT found
(531, -2, 527, 528),
(532, -2, 530, 531); -- Return if Lathoric or Dorius is found or if Obsidion is not found
...
(3566,0,34,532,0,0,0,0,0,0,0,0,0,'Terminate Script if Lathoric or Dorius is found or if Obsidion is not found',0,0,0,0),
...
(3566,66,10,8391,300000,0,0,0,0,0,0,0,0,'Summon Lathoric the Black',-6461.91,-1254.6,180.578,3.54302), -- Exact spawn is unknown and impossible to make out from the video(3566,64,5,46,256,0,0,0,0,0,8400,20,0,'Obsidion - Remove UNIT_FLAG_IMMUNE_TO_PLAYER',0,0,0,0),
...
(1282,0,34,532,0,0,0,0,0,0,0,0,0,'Terminate Script if Lathoric or Dorius is found or if Obsidion is not found',0,0,0,0),
