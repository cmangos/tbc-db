...
DELETE FROM `spawn_group` WHERE `Id` IN (448,449,450);
DELETE FROM `spawn_group_spawn` WHERE `Id` IN (448,449,450);
DELETE FROM `spawn_group_entry` WHERE `Id` IN (448,449,450);
DELETE FROM `gameobject` WHERE `id` = 0 AND `guid` BETWEEN 142470 AND 142500;
