...
UPDATE `creature_template` SET `SpeedWalk` = (2.5 / 2.5), `SpeedRun` = (8 / 7), `Detection` = 40, `PowerMultiplier` = 1.5, `MovementType` = 0, `MinLevelHealth` = 10138, `MaxLevelHealth` = 10484 WHERE `entry` IN (13358,13359);
