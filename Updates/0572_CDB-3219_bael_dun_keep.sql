...
UPDATE `creature` SET `id` = '0', `position_x` = '-4099.82080078125', `position_y` = '-2328.198486328125', `position_z` = '126.21124267578125', `orientation` = '1.884955525398254394' WHERE (`guid` = '13642');
UPDATE `creature` SET `id` = '0', `position_x` = '-4086.07080078125', `position_y` = '-2322.52734375', `position_z` = '126.2125167846679687', `orientation` = '2.042035102844238281' WHERE (`guid` = '13643');
