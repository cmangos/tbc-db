...
-- https://classic.wowhead.com/npc=15990/kelthuzad#comments:id=2919924 - ash nazg thrakatulûk agh burzum-ishi krimpatul
UPDATE `creature_loot_template` SET `comments` = 'Naxxramas (Boss Loot) - Kel\'thuzad  - Epic Items (T3 Ring)' WHERE `entry` = 15990 AND `mincountOrRef` = -34044;
