...
ALTER TABLE `waypoint_path` CHANGE `orientation` `Orientation` FLOAT NOT NULL DEFAULT '100';
ALTER TABLE `waypoint_path` CHANGE `waittime` `WaitTime` INT UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `waypoint_path` CHANGE `script_id` `ScriptId` MEDIUMINT UNSIGNED NOT NULL DEFAULT '0';
...
ALTER TABLE `creature_movement` CHANGE `orientation` `Orientation` FLOAT NOT NULL DEFAULT '100';
ALTER TABLE `creature_movement` CHANGE `waittime` `WaitTime` INT UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `creature_movement` CHANGE `script_id` `ScriptId` MEDIUMINT UNSIGNED NOT NULL DEFAULT '0';
...
ALTER TABLE `creature_movement_template` CHANGE `pathId` `PathId` INT UNSIGNED NOT NULL DEFAULT '0';
...
ALTER TABLE `creature_movement_template` CHANGE `orientation` `Orientation` FLOAT NOT NULL DEFAULT '100';
ALTER TABLE `creature_movement_template` CHANGE `waittime` `WaitTime` INT UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `creature_movement_template` CHANGE `script_id` `ScriptId` MEDIUMINT UNSIGNED NOT NULL DEFAULT '0';
...
ALTER TABLE `script_waypoint` CHANGE `pathId` `PathId` INT UNSIGNED NOT NULL DEFAULT '0';
...
ALTER TABLE `script_waypoint` CHANGE `orientation` `Orientation` FLOAT NOT NULL DEFAULT '100';
ALTER TABLE `script_waypoint` CHANGE `waittime` `WaitTime` INT UNSIGNED NOT NULL DEFAULT '0';
ALTER TABLE `script_waypoint` CHANGE `script_id` `ScriptId` MEDIUMINT UNSIGNED NOT NULL DEFAULT '0';
