...
UPDATE quest_template SET ExclusiveGroup = 0 WHERE entry = 8578; -- -8578
-- starts from:
-- o.180642 'Inconspicuous Crate'
DELETE FROM gameobject_questrelation WHERE id=180642 AND quest=8578; -- https://tbc.wowhead.com/object=180642/inconspicuous-crate
...
UPDATE quest_template SET ExclusiveGroup = 0 WHERE entry = 8587; -- -8578
-- 3rd:
...
-- https://tbc.wowhead.com/quest=8729/the-wrath-of-neptulon#comments:id=83809
-- the next day, the quest giver sends you 100g in the mail.
-- ~36 hours after you complete the quest, you'll receive a letter with 100 gold from Narain Soothfancy. Message reads as follows:
UPDATE quest_template SET /*RewMailTemplateId=123, RewMailDelaySecs=0, */RequiredCondition=3815 WHERE entry=8728; -- 123 86400 0
...
-- UPDATE quest_template SET RequiredCondition=3819 WHERE entry = 8742; -- duplicate line above
