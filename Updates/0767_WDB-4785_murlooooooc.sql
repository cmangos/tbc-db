...
-- Spawn Groups
UPDATE creature SET position_x = -9533.875, position_y = -247.13477, position_z = 59.253498, spawndist = 0, MovementType = 0, spawntimesecsmin = 180, spawntimesecsmax = 180 WHERE guid IN (81075,81076);
DELETE FROM `creature_movement` WHERE `id` IN (81075,81076);
DELETE FROM `creature_linking` WHERE `master_guid` IN (81075,81076);
