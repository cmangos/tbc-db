...
UPDATE reference_loot_template SET ChanceOrQuestChance='75' WHERE entry='65004' and item='5971';
...
DELETE FROM `creature_loot_template` WHERE `mincountOrRef` = -65020;
...
DELETE FROM `creature_loot_template` WHERE `mincountOrRef` = -65049;
...
UPDATE reference_loot_template SET ChanceOrQuestChance='15', groupid='1' WHERE entry='65050' AND item='8491';
...
UPDATE reference_loot_template SET ChanceOrQuestChance='70', groupid='1' WHERE entry='65051' AND item='4261';
...
DELETE FROM `reference_loot_template` WHERE `entry` = 65172;
...
DELETE FROM creature_loot_template WHERE entry='8503' AND mincountOrRef='-65172';
