...
DELETE FROM `creature` WHERE `guid` = 49850 AND `id` = 2038; -- Lord Melenas - duplicate guid 1550
DELETE FROM `creature` WHERE `guid` = 37003 AND `id` = 2337; -- Dark Strand Voidcaller - duplicate guid 37006 due to movement
DELETE FROM `creature` WHERE `guid` = 97065 AND `id` = 19399; -- duplicate 69253 falling below ground
...
UPDATE `creature_movement_template` SET `script_id` = 1000 WHERE `entry` = 54 AND `point` IN (2,4);
