...
(14754, 21565, 0, 0, 0, 1054, 0, 'Rune of Perfection'),
(14754, 21566, 0, 0, 0, 1055, 0, 'Rune of Perfection');
...
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20044, 0, 0, 41, 427, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20044/highlanders-mail-girdle
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20118, 0, 0, 42, 933, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20118/highlanders-mail-girdle
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20119, 0, 0, 43, 887, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20119/highlanders-mail-girdle
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20120, 0, 0, 44, 841, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20120/highlanders-mail-girdle
...
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20051, 0, 0, 49, 427, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20051/highlanders-mail-greaves
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20121, 0, 0, 50, 933, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20121/highlanders-mail-greaves
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20122, 0, 0, 51, 887, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20122/highlanders-mail-greaves
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20123, 0, 0, 52, 841, 'Highlander\'s Mail Girdle'); -- https://tbc.wowhead.com/item=20123/highlanders-mail-greaves
...
REPLACE INTO `npc_vendor` (`entry`, `item`, `maxcount`, `incrtime`, `slot`, `ExtendedCost`, `comments`) VALUES (15127, 20056, 0, 0, 74, 501, 'Highlander\'s Mail Pauldrons');  -- https://tbc.wowhead.com/item=20056/highlanders-mail-pauldrons
...
-- tbc+
-- https://wowwiki-archive.fandom.com/wiki/Alliance_Brigadier_General?oldid=1392839
UPDATE `creature_template` SET `NpcFlags` = 3 WHERE `entry` IN (15350,15351);
DELETE FROM `gossip_menu_option` WHERE `menu_id` IN (6597,6598); -- this makes the gossip visible
UPDATE `quest_template` SET `RewMoneyMaxLevel` = 0 WHERE `entry` = 8385; -- alliance version gave gold in repetition
UPDATE `quest_template` SET `ReqItemId1` = 20558, `ReqItemId2` = 20559, `ReqItemId3` = 20560, `ReqItemId4` = 29024 WHERE `entry` IN (8367,8371,8385,8388);
UPDATE `quest_template` SET `RewMoneyMaxLevel` = 109900 WHERE `entry` IN (8367,8371);
