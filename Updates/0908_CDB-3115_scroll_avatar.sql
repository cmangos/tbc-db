...
DELETE FROM gossip_menu WHERE entry=1470 AND text_id IN (2139,4563);
...
-- DELETE FROM npc_text WHERE ID IN (4563, 4565); -- already deleted
-- DELETE FROM npc_text_broadcast_text WHERE Id IN (4563, 4565); -- wrong delete for this insert
...
-- (2139, 1, 0, 0, 0, 0, 0, 0, 0, 4563, 0, 0, 0, 0, 0, 0, 0), -- already exist
