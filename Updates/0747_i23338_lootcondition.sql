...
(9009, -3, 9008, 0, 'NOT (Quest ID 9373 Rewarded OR Quest ID 9373 Taken)'),
(9010, -1, 9009, 9007, '(Quest ID 9373 Rewarded OR Quest ID 9373 Taken) AND (Player Has Less Than 1 of Item ID 23338 in Inventory)');
