...
-- classic ONLY -> tbc data was classic data.
UPDATE `creature_template` SET `DamageMultiplier`=1 WHERE `entry`=4872; -- Obsidian Golem (was 1.8, is elite in classic) - 51-68dmg at 37 results in multiplier of 1!
UPDATE `creature_template` SET `DamageMultiplier`=1 WHERE `entry`=8447; -- Clunk (was 2.8, nonelite in tbc+) - 72-96 at 44 results in multiplier of 1!
