DELETE FROM gameobject WHERE guid = '50195';
DELETE FROM gameobject WHERE guid = '50196';
...
('2879', '9', '50224', '22', 'The Stave of Equinex: Equinex Monolith Lights 1 - Respawn GameObject');
