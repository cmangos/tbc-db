...
(3001,34529,100000,164,350,0,@CONDITION+12),
(3001,34530,250000,164,375,0,@CONDITION+12),
(3001,34533,100000,164,350,0,@CONDITION+12),
(3001,34534,250000,164,375,0,@CONDITION+12),
(3001,36122,10000,164,260,0,@CONDITION+12),
(3001,36124,10000,164,260,0,@CONDITION+12),
(3001,36129,40000,164,330,0,@CONDITION+12),
(3001,36130,40000,164,330,0,@CONDITION+12),
(3001,36256,500000,164,375,0,@CONDITION+12),
(3001,36257,500000,164,375,0,@CONDITION+12);
-- (3001,55186,50000,164,415,0,@CONDITION+12),
-- (3001,55187,50000,164,415,0,@CONDITION+12);
...
(3002,36125,10000,164,260,0,@CONDITION+9),
(3002,36126,10000,164,260,0,@CONDITION+9),
(3002,36128,10000,164,260,0,@CONDITION+9),
-- (3002,55183,50000,164,415,0,@CONDITION+9),
-- (3002,55184,50000,164,415,0,@CONDITION+9),
-- (3002,55185,50000,164,415,0,@CONDITION+9),
-- req. 17039 'Master Swordsmith'
(3002,34535,100000,164,350,0,@CONDITION+2),
(3002,34537,250000,164,375,0,@CONDITION+2),
(3002,34538,100000,164,350,0,@CONDITION+2),
(3002,34540,250000,164,375,0,@CONDITION+2),
(3002,36131,40000,164,330,0,@CONDITION+2),
(3002,36133,40000,164,330,0,@CONDITION+2),
(3002,36258,500000,164,375,0,@CONDITION+2),
(3002,36259,500000,164,375,0,@CONDITION+2),
-- req. 17040 'Master Hammersmith'
(3002,34545,100000,164,350,0,@CONDITION),
(3002,34546,250000,164,375,0,@CONDITION),
(3002,34547,100000,164,350,0,@CONDITION),
(3002,34548,250000,164,375,0,@CONDITION),
(3002,36136,40000,164,330,0,@CONDITION),
(3002,36137,40000,164,330,0,@CONDITION),
(3002,36262,500000,164,375,0,@CONDITION),
(3002,36263,500000,164,375,0,@CONDITION),
-- req. 17041 'Master Axesmith'
(3002,34541,100000,164,350,0,@CONDITION+1),
(3002,34542,250000,164,375,0,@CONDITION+1),
(3002,34543,100000,164,350,0,@CONDITION+1),
(3002,34544,250000,164,375,0,@CONDITION+1),
(3002,36134,40000,164,330,0,@CONDITION+1),
(3002,36135,40000,164,330,0,@CONDITION+1),
(3002,36260,500000,164,375,0,@CONDITION+1),
(3002,36261,500000,164,375,0,@CONDITION+1);
