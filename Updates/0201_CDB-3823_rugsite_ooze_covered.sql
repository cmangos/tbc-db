DELETE FROM `gameobject` WHERE `guid` BETWEEN 110188 AND 110220;
DELETE FROM `pool_gameobject` WHERE `pool_entry` IN	(8771,8772,8773,8774,8775,8776,8777,8778,8779,8780,8781);
DELETE FROM `pool_template` WHERE `entry` IN 		(8771,8772,8773,8774,8775,8776,8777,8778,8779,8780,8781);
DELETE FROM `pool_pool` WHERE `pool_id` IN			(8771,8772,8773,8774,8775,8776,8777,8778,8779,8780,8781);
DELETE FROM `pool_template` WHERE `entry` = 2056; -- Master Mineral Pool - Thousand Needles (Ooze Covered Mineral GOs)
