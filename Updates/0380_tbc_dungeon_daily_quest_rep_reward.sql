...
UPDATE `quest_template` SET `rewrepfaction1` = 933, `rewrepfaction2` = 947, `rewrepvalue1` = 350, `rewrepvalue2` = 350 WHERE `entry` = 11354; -- Wanted: Nazan\'s Riding Crop
UPDATE `quest_template` SET `rewrepfaction1` = 933, `rewrepfaction2` = 947, `rewrepvalue1` = 350, `rewrepvalue2` = 350 WHERE `entry` = 11362; -- Wanted: Keli\'dan\'s Feathered Stave
UPDATE `quest_template` SET `rewrepfaction1` = 933, `rewrepfaction2` = 947, `rewrepvalue1` = 350, `rewrepvalue2` = 350 WHERE `entry` = 11363; -- Wanted: Bladefist\'s Seal
UPDATE `quest_template` SET `rewrepfaction1` = 933, `rewrepfaction2` = 946, `rewrepvalue1` = 250, `rewrepvalue2` = 250 WHERE `entry` = 11364; -- Wanted: Shattered Hand Centurions
