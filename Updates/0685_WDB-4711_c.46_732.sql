...
-- same except 99696,99694,99695 only present in tbcmangos
DELETE FROM `creature` WHERE `guid` = 99696; -- d.81305
DELETE FROM `creature_movement` WHERE `id` = 99696;

DELETE FROM `creature` WHERE `guid` = 99694; -- d.81315
DELETE FROM `creature_movement` WHERE `id` = 99694;

DELETE FROM `creature` WHERE `guid` = 99695; -- d.81317
DELETE FROM `creature_movement` WHERE `id` = 99695;
