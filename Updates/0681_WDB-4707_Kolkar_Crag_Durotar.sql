...
DELETE FROM `pool_creature` WHERE `pool_entry` IN (1253);
DELETE FROM `pool_template` WHERE `entry` IN (1253); -- 1253	1	Warlord Kolkanis (5808)
DELETE FROM `pool_creature_template` WHERE `pool_entry` IN (1253); -- 5808	1253	0	Warlord Kolkanis (5808)
...
(19987, 12269, -1), -- different guids in classic/tbc compared to wotlk
(19987, 12268, -1),
(19987, 12260, -1);

-- updates c.id.3119,3120 (spawns are identical between repos)
...
-- 12926
(12926,1,-946.34204,-4497.454,28.634068,100,1000,312001),
