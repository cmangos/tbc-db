...
DELETE FROM game_event WHERE entry=14;
INSERT INTO game_event (entry, start_time, end_time, occurence, length, holiday, linkedTo, description) VALUES
(14, '2006-01-02 00:00:00', '2030-12-31 23:59:00', 4320, 2160, 0, 0, 'Elemental Invasion: Air');
...
(@GUID + 1, 179667, 1, 1, -6566.5, 1800.88, 3.25358, -1.98968, 0, 0, -0.838672, 0.544637, 300, 300, 0, 1),     -- Air Elemental Rifts
(@GUID + 2, 179667, 1, 1, -6566.51, 1933.53, 6.48758, -1.16937, 0, 0, -0.551937, 0.833886, 300, 300, 0, 1),
(@GUID + 3, 179667, 1, 1, -6465.79, 1866.83, 3.8172, 3.14159, 0, 0, 0, 0.00000126759, 300, 300, 0, 1),
(@GUID + 4, 179667, 1, 1, -6368.79, 1433.82, 4.54176, -0.558505, 0, 0, -0.275637, 0.961262, 300, 300, 0, 1),
(@GUID + 5, 179667, 1, 1, -6449.7, 1451.1, -1.33023, -0.523599, 0, 0, -0.258819, 0.965926, 300, 300, 0, 1),
(@GUID + 6, 179667, 1, 1, -6567.16, 1500.09, 3.49323, -0.226893, 0, 0, -0.113203, 0.993572, 300, 300, 0, 1);
...
(@GUID + 1, 14454, 1, 1, 0, 0, -6582, 1539.14, 2.156, 4.863974, 60*60*24*1.5, 60*60*24*1.5, 25, 0, 15772, 0, 0, 2),
(@GUID + 2, 14455, 1, 1, 0, 0, -6582.85, 1548.14, 1.25125, 4.82942, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2871, 0, 0, 0),
(@GUID + 3, 14455, 1, 1, 0, 0, -6590.99, 1545.18, 3.15098, 4.68177, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2784, 0, 0, 0),
(@GUID + 4, 14455, 1, 1, 0, 0, -6573.75, 1544.65, -0.824519, 4.68177, 60*60*24*1.5, 60*60*24*1.5, 0, 0, 2871, 0, 0, 0);
