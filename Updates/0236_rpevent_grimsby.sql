...
(@PATH,0,1,-2948.3582,-3893.1711,35.094315,100,260000,0),
...
(@PATH,0,5,-2948.0425,-3893.423,35.094315,100,0,0);


DELETE FROM dbscripts_on_creature_movement WHERE id = 2384301;
...
DELETE FROM dbscripts_on_creature_movement WHERE id = 2384302;
DELETE FROM dbscripts_on_creature_movement WHERE id = 2384303;