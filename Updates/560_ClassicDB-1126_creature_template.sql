...
UPDATE `creature_template` SET `SpeedWalk`='1', `SpeedRun`='2.142857143', `Rank`='2', `MeleeBaseAttackTime`='2000', `MovementType`='1' WHERE `Entry`='5831';
...
('5831', '1', '-702.322', '-3593.87', '93.8325', '0', '5', '0', '0', '0', '0', '0', '0', '0', '100', '0', '0');
