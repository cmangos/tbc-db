...
-- 9 Missing Clefthoof spawns and 1 missing Clefthoof Calf spawn
-- Instead of moving all 97 Clefthoof spawns to a new range I moved the Murkblood Putrifiers and Raiders, which were just before the Clefthoof GUIDs. 
-- They had no existing linking, movement or creature_addon, so moving them is safe.
