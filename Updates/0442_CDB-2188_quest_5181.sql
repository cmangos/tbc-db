...
UPDATE creature SET spawntimesecsmin=30, spawntimesecsmax=30 WHERE id IN (11288, 11289, 11620, 11621); -- 345	345

-- Despawn Spectral Combatants 17678 - TARGET_LOCATION_CASTER_SRC, TARGET_ENUM_UNITS_SCRIPT_AOE_AT_DEST_LOC
