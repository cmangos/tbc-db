...
-- Well Watcher Solanian (all classes) - not needed as prevquest has the RequiredClasses 
...
UPDATE quest_template SET RequiredClasses = 8 WHERE entry = 10071; -- rogue - 9392
UPDATE quest_template SET RequiredClasses = 16, PrevQuestId = 8564 WHERE entry = 10072; -- priest
UPDATE quest_template SET RequiredClasses = 256 WHERE entry = 10073; -- warlock - 8563
