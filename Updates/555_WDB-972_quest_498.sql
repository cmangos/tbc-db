...
(312,1,0,0,0,2239,20,7,2000001311,0,0,0,0,0,0,0,'force 2239 to: say text'),
(312,4,1,6,0,2239,20,7,0,0,0,0,0,0,0,0,'force 2239 to: emote'),
(312,7,0,0,0,2239,20,7,2000001312,0,0,0,0,0,0,0,'force 2239 to: say text'),
-- #313
...
UPDATE dbscript_string SET emote = 5 WHERE entry = 2000001311;
UPDATE dbscript_string SET emote = 1 WHERE entry = 2000001312;
