...
(11028,0,45,10069,0,0,0,0,0,0,23306,10,0,'Sky Commander Adaris - Start relay script with Hazzik as source and Player as target',0,0,0,0),
...
DELETE FROM `dbscripts_on_relay` WHERE `id` IN(10069);
...
(10069,0,0,0,0,0,2000001454,0,0,0,0,0,0,'Hazzik - You over there!  I must speak with you!',0,0,0,0);
