...
SET @CGUID := 191137;
DELETE FROM `creature` WHERE `guid` BETWEEN 191137 AND 191220;
INSERT INTO `creature` (`guid`, `id`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES
(@CGUID := @CGUID + 0, 721, 0, -4841.438, -1702.254, 505.4502, 4.417192, 300, 300, 10, 1), -- Rabbit
(@CGUID := @CGUID + 1, 721, 0, -4702.596, -1659.312, 504.5119, 3.543274, 300, 300, 10, 1), -- Rabbit
(@CGUID := @CGUID + 1, 721, 0, -4511.078, -1645.974, 504.8916, 4.436601, 300, 300, 10, 1), -- Rabbit
