...
INSERT INTO `creature_spell_list` (`Id`, `Position`, `SpellId`, `Flags`, `CombatCondition`, `TargetId`, `ScriptId`, `Availability`, `Probability`, `InitialMin`, `InitialMax`, `RepeatMin`, `RepeatMax`, `Comments`) VALUES
(1942901, 1, 38059, 0, -1, 1, 0, 100, 0, 5000, 20000, 11000, 26000, 'Avian Darkhawk - Sonic Charge - current'),
(1942901, 2, 32901, 0, -1, 1, 0, 100, 0, 5000, 18000, 10000, 25000, 'Avian Darkhawk - Carnivorous Bite - current'),

(2068601, 1, 39197, 0, -1, 1, 0, 100, 0, 5000, 20000, 11000, 26000, 'Avian Darkhawk - Sonic Charge - current'),
