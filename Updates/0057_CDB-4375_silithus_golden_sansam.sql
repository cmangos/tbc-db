...
-- https://www.wowhead.com/tbc/object=176583/golden-sansam

-- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

DELETE FROM `gameobject` WHERE (`guid` IN (138969, 138971, 138972, 138973, 138974, 138975, 138976, 138977, 138978, 138979, 138980, 138981, 138982, 138983, 138984, 138985, 138986, 138987, 138989, 138990, 138991, 138994, 
138995, 138996, 138997, 138998, 138999));
DELETE FROM `pool_gameobject` WHERE (`guid` IN (138969, 138971, 138972, 138973, 138974, 138975, 138976, 138977, 138978, 138979, 138980, 138981, 138982, 138983, 138984, 138985, 138986, 138987, 138989, 138990, 138991, 138994, 
138995, 138996, 138997, 138998, 138999));
-- DELETE FROM `pool_template` WHERE (`entry` IN (8507, 8510, 8513, 8516, 8519, 8523));
UPDATE `pool_template` SET `max_limit` = 11 WHERE `entry` = 13035; -- 15	Master Herb Pool - Silithus
