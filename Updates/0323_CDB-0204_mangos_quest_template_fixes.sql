...
UPDATE `quest_template` SET `MinLevel` = 5 WHERE `entry` = 751; -- 6
...
UPDATE `quest_template` SET `MinLevel` = 1 WHERE `entry` = 755; -- 2
-- Source: http://www.wowwiki.com/Quest:Thunderhorn_Totem?oldid=144855
UPDATE `quest_template` SET `MinLevel` = 5 WHERE `entry` = 756; -- 4
-- Source: http://www.wowwiki.com/Quest:Thunderhorn_Cleansing?oldid=144870
UPDATE `quest_template` SET `MinLevel` = 5 WHERE `entry` = 758; -- 4
-- Source: http://www.wowwiki.com/Quest:Wildmane_Totem?oldid=145421
UPDATE `quest_template` SET `MinLevel` = 7 WHERE `entry` = 759; -- 4
-- Source: http://www.wowwiki.com/Quest:Wildmane_Cleansing?oldid=145434
UPDATE `quest_template` SET `MinLevel` = 7 WHERE `entry` = 760; -- 9
-- Source: http://www.wowwiki.com/Quest:Rites_of_the_Earthmother?oldid=138106
UPDATE `quest_template` SET `MinLevel` = 1 WHERE `entry` = 763; -- 3
...
UPDATE `quest_template` SET `MinLevel` = 4 WHERE `entry` = 773; -- 5
-- Source: http://www.wowwiki.com/Quest:Journey_into_Thunder_Bluff?oldid=138266
UPDATE `quest_template` SET `MinLevel` = 4 WHERE `entry` = 775; -- 8
-- Source: http://www.wowwiki.com/Quest:Rites_of_the_Earthmother_(3)?oldid=138270
UPDATE `quest_template` SET `MinLevel` = 7 WHERE `entry` = 776; -- 3
