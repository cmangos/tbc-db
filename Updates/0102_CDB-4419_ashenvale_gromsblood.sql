-- https://github.com/cmangos/classic-db/commit/ac556b55814e0b2b2bc32420a8228853e3d9a2a5
/*
03 08
05 10
03 12
...
-- Gromsblood
DELETE FROM `gameobject` WHERE (`guid` IN (136785,136782,136783,136780,136779,136778,136781,136784));
DELETE FROM `pool_gameobject` WHERE (`guid` IN (136785,136782,136783,136780,136779,136778,136781,136784));
