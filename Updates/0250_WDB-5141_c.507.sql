...
DELETE FROM creature_addon WHERE guid BETWEEN 98679 AND 98685;
DELETE FROM creature_movement WHERE id BETWEEN 98679 AND 98685;
DELETE FROM game_event_creature WHERE guid BETWEEN 98679 AND 98685;
DELETE FROM game_event_creature_data WHERE guid BETWEEN 98679 AND 98685;
DELETE FROM creature_battleground WHERE guid BETWEEN 98679 AND 98685;
DELETE FROM creature_linking WHERE guid BETWEEN 98679 AND 98685
 OR master_guid BETWEEN 98679 AND 98685;
DELETE FROM creature WHERE guid BETWEEN 98679 AND 98685;
-- Removed from pools
DELETE FROM pool_creature_template WHERE id = 507; -- 507	1054	0	Fenros (507)
DELETE FROM pool_template WHERE entry = 1054; -- 1054	1	Fenros (507)
-- wps
