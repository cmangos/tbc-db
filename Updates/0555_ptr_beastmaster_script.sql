...
DELETE FROM `gossip_menu` WHERE `entry` IN (26301, 26302, 26303); -- -0
INSERT INTO `gossip_menu` (`entry`, `text_id`, `condition_id`) VALUES
(26301, 25329, 0),
(26302, 25328, 0),
(26303, 10622, 0);

DELETE FROM `gossip_menu_option` WHERE `menu_id` IN (26301, 26302, 26303); -- -0
...
DELETE FROM `dbscripts_on_gossip` WHERE `id` BETWEEN 2630701 AND 2630715; -- -0
...
UPDATE `creature_template` SET `TrainerTemplateId`=2020 WHERE `Entry`=26307; -- pet trainer template
