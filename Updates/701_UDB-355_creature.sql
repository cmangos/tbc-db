...
UPDATE creature_model_info SET modelid_other_gender = 0 WHERE modelid = 5809;
...
(705201,3,32,1,0,7052,66991,7 | 0x10,0,0,0,0,0,0,0,0,'pause wp'),
...
(705201,25,32,0,0,7052,66991,7 | 0x10,0,0,0,0,0,0,0,0,'unpause wp'),
