...
SET @CGUID := 5306009;
DELETE FROM `creature` WHERE `id` = 19416;
...
-- Reinsert existing spawns - missing in wotlkmangos
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES
(@CGUID+32, 19416, 530, 1, -3400.18994140625000000000, 5185.93994140625000000000, -88.81279754638672000000, 0.01745329983532428700, 120, 120, 0, 0),
(@CGUID+33, 19416, 530, 1, -3387.16992187500000000000, 5177.64990234375000000000, -95.55580139160156000000, 1.39626002311706540000, 120, 120, 0, 0),
(@CGUID+34, 19416, 530, 1, -3383.70996093750000000000, 5192.25000000000000000000, -97.21050262451172000000, 3.82226991653442400000, 120, 120, 0, 0),
(@CGUID+35, 19416, 530, 1, -3330.13989257812500000000, 5182.81005859375000000000, -89.36019897460938000000, 1.58825004100799560000, 120, 120, 0, 0),
(@CGUID+36, 19416, 530, 1, -3330.10009765625000000000, 5185.81982421875000000000, -88.56259918212890000000, 4.39823007583618200000, 120, 120, 0, 0);

-- All of the Draeneis have Aura that makes them invisible for players, they only get visible when Player has finished Quest Vision of the Dead - https://www.wowhead.com/tbc/quest=10252/vision-of-the-dead
...
-- https://www.wowhead.com/tbc/npc=19416/ancient-draenei-spirit
DELETE FROM `creature_template_addon` WHERE `entry` = 19416;
INSERT INTO `creature_template_addon` (`entry`, `auras`, `sheath_state`) VALUES(19416, '32648', 1); -- made visible with s.32649 rewarded by q.10252

-- https://www.wowhead.com/tbc/npc=18687/mother-kashur
DELETE FROM `creature_template_addon` WHERE `entry` = 18687;
INSERT INTO `creature_template_addon` (`entry`, `auras`, `sheath_state`) VALUES(18687, '32648', 1);

-- https://www.wowhead.com/tbc/npc=18688/ancient-orc-ancestor - exists

-- https://www.wowhead.com/tbc/npc=18904/vision-of-the-forgotten
DELETE FROM `creature_template_addon` WHERE `entry` = 18904;
INSERT INTO `creature_template_addon` (`entry`, `auras`, `sheath_state`) VALUES(18904, '32648', 1);

-- https://www.wowhead.com/tbc/npc=19412/dore - Instance File
...
INSERT INTO `creature_template_addon` (`entry`, `auras`, `sheath_state`) VALUES(19719, '32648', 1); -- emote 14 removed, script?

-- https://www.wowhead.com/tbc/npc=19879/horvon-the-armorer - exists

-- https://www.wowhead.com/tbc/npc=21318/spirit-of-artor - interesting, sheath_state corrected.
DELETE FROM `creature_template_addon` WHERE `entry` = 21318;
INSERT INTO `creature_template_addon` (`entry`, `auras`, `sheath_state`) VALUES(21318, '32648', 1);

-- https://www.wowhead.com/tbc/quest=10252/vision-of-the-dead
-- Completion
-- Stranger... I was not forthright with you. Once you drink this potion, you will forever see into the world of the dead.
-- This recipe that you drink of is a rite of initiation for all death priests of Auchindoun. Many go mad after its effects have taken hold. Seeing the dead is ... shocking.
UPDATE `quest_template` SET `RewSpellCast` = 32649 WHERE `entry` = 10252; -- Commune With The Ancestors

DELETE FROM `creature_addon` WHERE `guid` BETWEEN @CGUID+1 AND @CGUID+31;
INSERT INTO creature_addon (`guid`, `stand_state`, `auras`, `sheath_state`) VALUES
(@CGUID+9, 8, '32648', 1),
(@CGUID+10, 8, '32648', 1),
(@CGUID+11, 8, '32648', 1),
(@CGUID+12, 8, '32648', 1),
...
(19100, 'Terokkar Forest - Levixus <The Soul Caller> - Draenei Spirits');

DELETE FROM `conditions` WHERE `condition_entry` = 19100;
INSERT INTO `conditions` (`condition_entry`, `type`, `value1`, `value2`, `value3`, `value4`, `flags`, `comments`) VALUES
(19100, 42, 19100, 1, 0, 0, 0, 'Terokkar Forest - Levixus <The Soul Caller> - Draenei Spirits');

-- Spell List for Levixus <The Soul Caller>
...
DELETE FROM dbscript_random_templates WHERE id = 1984701; -- 17446 as emote in acid
INSERT INTO dbscript_random_templates (`id`, `type`, `target_id`, `comments`) VALUES
(1984701, 0, 17447, 'Levixus <The Soul Caller> -  OOC Texts'),
(1984701, 0, 17448, 'Levixus <The Soul Caller> -  OOC Texts'),
(1984701, 0, 17453, 'Levixus <The Soul Caller> -  OOC Texts'),
(1984701, 0, 17454, 'Levixus <The Soul Caller> -  OOC Texts');
...
(1984701, 'Levixus <The Soul Caller>', 0, 0);

DELETE FROM creature_spell_list WHERE Id = '1984701';
INSERT INTO creature_spell_list(Id, Position, SpellId, Flags, CombatCondition, TargetId, ScriptId, Availability, Probability, InitialMin, InitialMax, RepeatMin, RepeatMax, Comments) VALUES
('1984701', '0', '11443', '0', '-1', '1', '0', '100', '0','6000','12000','13000','26000', 'Levixus <The Soul Caller> - Cripple - on current'),
('1984701', '1', '7645', '0', '-1', '101', '0', '100', '0','9000','18000','15000','30000', 'Levixus <The Soul Caller> - Dominate Mind - random not Tank'),
('1984701', '2', '38939', '0', '-1', '1', '0', '100', '0','10000','20000','18000','36000', 'Levixus <The Soul Caller> - Inferno - on current');
...
(1984701, 0, 0, 53, 0, 0, 0, 0, 0, 0, 19100, 0, 0, 0, 0, 0, 0, 0, 'Levixus <The Soul Caller> - Set Worldstate');
...
(19847, 0, 0, 53, 0, 0, 0, 0, 0, 0, 19100, 1, 0, 0, 0, 0, 0, 0, 'Levixus <The Soul Caller> - Set Worldstate');
...
-- [1] Scale: 1.5
-- https://github.com/cmangos/tbc-db/blob/846a6840e07808d01ad9196b49b0ca8b98b85e56/Updates/0533_CDB-2669_gameobject_template_updates.sql#L1451
UPDATE `gameobject_template` SET `size`='1.5' WHERE (`entry`='183983'); -- seemingly corrected already?
