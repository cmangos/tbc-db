...
UPDATE gameobject_template a SET ExtraFlags=ExtraFlags|0x00000002 WHERE data2>0 AND type=10 AND exists(select guid from gameobject b where map IN(30,37,489,529,559,607,628));
