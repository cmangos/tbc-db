...
('1112', '0', '29', '2', '2', '0', '0', 'Parts for Kravel: Kravel Koalbeard - Toggle NPC Flags'),
...
('1112', '15000', '29', '2', '2', '0', '0', 'Parts for Kravel: Parts Crate - Toggle NPC Flags');
...
('1116', '0', '29', '2', '2', '0','0', '0', 'Dream Dust in the Swamp: Krazek - Toggle NPC Flags'),
...
('1116', '12000', '29', '2', '2', '0','0', '0', 'Dream Dust in the Swamp: Krazek - Toggle NPC Flags');

-- Completion script for quest Rumors for Kravel.
DELETE FROM `dbscripts_on_quest_end` WHERE id = '1117';
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `data_flags`, `dataint`, `o`, `comments`) VALUES 
('1117', '0', '29', '2', '2', '0','0', '0', 'Rumors for Kravel: Kravel Koalbeard - Toggle NPC Flags'),
...
('1117', '11000', '29', '2', '2', '0','0', '0', 'Rumors for Kravel: Kravel Koalbeard - Toggle NPC Flags');

-- Back to booty Bay
DELETE FROM `dbscripts_on_quest_end` WHERE id = '1118';
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `o`, `comments`) VALUES 
('1118', '0', '29', '2', '2', '0', '0', 'Back to Booty Bay - Crank Fizzlebub - Toggle NpcFlags'),
...
('1118', '6000', '29', '2', '2', '0', '0', 'Back to Booty Bay - Crank Fizzlebub - Toggle NpcFlags'),
...
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `o`, `comments`) VALUES 
('621', '0', '29', '2', '2', '0', '0', 'Zanzil\'s Secret: Crank Fizzlebub - Toggle NpcFlags'),
...
('621', '5000', '29', '2', '2', '0', '0', 'Zanzil\'s Secret: Crank Fizzlebub - Toggle NpcFlags');