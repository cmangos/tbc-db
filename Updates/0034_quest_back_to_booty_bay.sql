...
('1112', '0', '29', '2', '0', '0', '0', 'Parts for Kravel: Kravel Koalbeard - Remove NPC Flags'),
...
('1112', '15000', '29', '2', '1', '0', '0', 'Parts for Kravel: Parts Crate - Add NPC Flags');
...
('1116', '0', '29', '2', '0', '0','0', '0', 'Dream Dust in the Swamp: Krazek - Remove NPC Flags'),
...
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `data_flags`, `dataint`, `o`, `comments`) VALUES 
('1117', '0', '29', '2', '0', '0','0', '0', 'Rumors for Kravel: Kravel Koalbeard - Remove NPC Flags'),
...
('1117', '11000', '29', '2', '1', '0','0', '0', 'Rumors for Kravel: Kravel Koalbeard - Add NPC Flags');

-- Back to booty Bay
DELETE FROM `dbscripts_on_quest_end` WHERE id = '1118';
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `o`, `comments`) VALUES 
('1118', '0', '29', '2', '0', '0', '0', 'Back to Booty Bay - Crank Fizzlebub - Remove NpcFlags'),
...
INSERT INTO `dbscripts_on_quest_end` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `o`, `comments`) VALUES 
('621', '0', '29', '2', '0', '0', '0', 'Zanzil\'s Secret: Crank Fizzlebub - Remove NpcFlags'),
...
('621', '5000', '29', '2', '1', '0', '0', 'Zanzil\'s Secret: Crank Fizzlebub - Add NpcFlags');