...
-- https://wowwiki-archive.fandom.com/wiki/Sever - 25 (Bestiary says 21, keep that for tbc)
...
UPDATE `creature_template` SET /*`MinLevel` = 25, `MaxLevel` = 25, */`MechanicImmuneMask` = `MechanicImmuneMask`|4194304|33554432 WHERE `entry` = 14682; -- 21
...
(14682, 60432, 0.5, 0, -60432, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 22-24) - (NPC Levels: 21)'),
(14682, 60126, 2, 0, -60126, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 20-24) - (NPC Levels: 21)'),
...
UPDATE `creature_template` SET `MovementType` = 2, `MechanicImmuneMask` = `MechanicImmuneMask`|4194304|33554432 WHERE `entry` = 14693; -- Movement on Spawn
...
-- patterns level 34 range

-- https://wowwiki-archive.fandom.com/wiki/Lady_Falther%27ess - 40 (Bestiary says 37, keep that for tbc)
-- https://tbc.wowhead.com/npc=14686/lady-faltheress#comments:id=3277093
UPDATE `creature_template` SET /*`MinLevel` = 40, `MaxLevel` = 40, */`Faction` = 35, `SpeedWalk` = 1, `MechanicImmuneMask` = 113983455 WHERE `entry` = 14686; -- 37
...
(14686, 60158, 2, 0, -60158, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 36-40) - (NPC Levels: 37)');
-- profession patterns level 37 range
...
(14684, 60008, 4, 0, -60008, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 51-60) - (NPC Levels: 51-60) - VANILLA NPC ONLY'),
(14684, 49003, 0.3, 0, -49003, 1, 0, 'Darkmoon Cards (Beasts, Elementals, Portals, Warlords 5-8) - (Elite NPC Levels: ~50+) - VANILLA NPC ONLY'),
(14684, 60280, 0.1, 0, -60280, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14684, 60340, 0.01, 0, -60340, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 59-61) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14684, 60294, 2, 0, -60294, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 59-63) - (NPC Levels: 60) - VANILLA NPC ONLY');
...
(14690, 60008, 3, 0, -60008, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 51-60) - (NPC Levels: 51-60) - VANILLA NPC ONLY'),
(14690, 60280, 0.1, 0, -60280, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14690, 60340, 0.01, 0, -60340, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 59-61) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14690, 60294, 2, 0, -60294, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 59-63) - (NPC Levels: 60) - VANILLA NPC ONLY');
...
(14695, 60008, 3.5, 0, -60008, 1, 0, 'NPC LOOT (Grey World Drop) - (Item Levels: 51-60) - (NPC Levels: 51-60) - VANILLA NPC ONLY'),
(14695, 49003, 0.1, 0, -49003, 1, 0, 'Darkmoon Cards (Beasts, Elementals, Portals, Warlords 5-8) - (Elite NPC Levels: ~50+) - VANILLA NPC ONLY'),
(14695, 60280, 0.1, 0, -60280, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 56-60) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14695, 60340, 0.01, 0, -60340, 1, 0, 'NPC LOOT (Purple World Drop) - (Item Levels: 59-61) - (NPC Levels: 60) - VANILLA NPC ONLY'),
(14695, 60294, 2, 0, -60294, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 59-63) - (NPC Levels: 60) - VANILLA NPC ONLY');
...
(60446, 20400, 0, 1, 1, 1, 6012, 'Pumpkin Bag'); -- Event 12 active
...
SELECT `entry`, 49004, 0.1, 1, -49004, 1, 0, 'Darkmoon Cards (Beasts, Elementals, Portals, Warlords 2-4) - (Normal NPC Levels: ~50+) - VANILLA NPC ONLY' FROM `creature_template` WHERE `entry` IN (
