...
(660, 0, 3, 'Astranaar - Theramore | Landing extracted from verified'),
(661, 4, 0, 'Theramore - Astranaar | Takeoff extracted from verified'),
(715, 0, 1, 'Mudsprocket - Theramore | Landing extracted from verified'),
(717, 2, 0, 'Theramore - Mudsprocket | Takeoff extracted from verified');
