...
UPDATE creature SET spawntimesecsmin = 300, spawntimesecsmax = 300 WHERE `guid` IN (44306,44307);
DELETE FROM creature_spawn_entry WHERE guid = 44305;
-- With TBC release group was reduced to 2 guards - TBC and WOTLK
DELETE FROM spawn_group_spawn WHERE guid IN (44308,44309,44251,44252);
-- Remove them from DB. 
DELETE FROM creature_addon WHERE guid IN (44308,44309,44251,44252);
DELETE FROM creature_movement WHERE id IN (44308,44309,44251,44252);
DELETE FROM game_event_creature WHERE guid IN (44308,44309,44251,44252);
DELETE FROM game_event_creature_data WHERE guid IN (44308,44309,44251,44252);
DELETE FROM creature_battleground WHERE guid IN (44308,44309,44251,44252);
DELETE FROM creature_linking WHERE guid IN (44308,44309,44251,44252);
DELETE FROM creature WHERE guid IN (44308,44309,44251,44252);
DELETE FROM creature_spawn_entry WHERE guid IN (44308,44309,44251,44252);
DELETE FROM spawn_group_spawn WHERE guid IN (44308,44309,44251,44252);
...
(42965, 11880, 1, 1, -7554.23, 1744.16, 5.76653, 4.59986, 300, 300, 0, 0), -- -7891.28, 1840.39, 3.55864, 4.21382 spawndist 25, 1
(42969, 11880, 1, 1, -7551.5, 1900.6, 5.6287, 4.59986, 300, 300, 0, 0),
