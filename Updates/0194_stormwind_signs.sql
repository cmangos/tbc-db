...
UPDATE gameobject SET position_x=-8830.692, position_y=615.203, position_z=94.16196, orientation=2.242746, rotation2=0.9006977, rotation3=0.4344464 WHERE id=2124 AND guid=26297;
...
(5198, 2171, 0, 1, -8827.229, 957.5023, 99.84704, 2.260197, 0, 0, 0.9044542, 0.4265707, 120, 120, 0, 0),
(5496, 2178, 0, 1, -8845.385, 922.9111, 101.7831, 2.068215, 0, 0, 0.8594065, 0.5112929, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(5517, 25350, 0, 1, -8863.895, 943.2568, 114.3284, 0.5061446, 0, 0, 0.2503796, 0.9681478, 120, 120, 0, 0),
(42877, 25351, 0, 1, -8851.105, 920.1844, 114.3284, 0.5061446, 0, 0, 0.2503796, 0.9681478, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(42878, 23300, 0, 1, -8897.939, 909.434, 110.7002, 5.201083, 0, 0, -0.5150375, 0.8571676, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(42860, 24719, 0, 1, -8727.88, 894.59, 100.5635, 0.6894043, 0, 0, 0.3379164, 0.9411761, 120, 120, 0, 0),
(42861, 24720, 0, 1, -8825.221, 959.1587, 99.84704, 5.401796, 0, 0, -0.426568, 0.9044555, 120, 120, 0, 0),
(42866, 24721, 0, 1, -8843.097, 924.1536, 101.7831, 5.209809, 0, 0, -0.5112925, 0.8594068, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(42867, 25352, 0, 1, -8704.108, 926.3359, 113.2273, 5.384343, 0, 0, -0.4344444, 0.9006986, 120, 120, 0, 0),
(42872, 25353, 0, 1, -8812.216, 935.5714, 108.2936, 3.813545, 0, 0, -0.9440889, 0.3296909, 120, 120, 0, 0),
(42873, 25354, 0, 1, -8790.714, 935.9266, 112.9862, 3.813545, 0, 0, -0.9440889, 0.3296909, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(10674, 2131, 0, 1, -8508.362, 659.8925, 99.9641, 0.6021398, 0, 0, 0.2965422, 0.9550198, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(4958, 2186, 0, 1, -8726.224, 892.5807, 100.5635, 3.831001, 0, 0, -0.9411755, 0.3379182, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(4972, 25355, 0, 1, -8687.896, 885.3235, 103.556, 2.242746, 0, 0, 0.9006977, 0.4344464, 120, 120, 0, 0),
(42869, 25356, 0, 1, -8667.109, 880.1191, 109.4213, 2.242746, 0, 0, 0.9006977, 0.4344464, 120, 120, 0, 0),
(42870, 25357, 0, 1, -8687.7, 863.7401, 109.4213, 2.242746, 0, 0, 0.9006977, 0.4344464, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(42871, 103794, 0, 1, -8825.397, 957.3259, 99.24699, 3.831001, 0, 0, -0.9411755, 0.3379182, 120, 120, 0, 0);
...
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(44700, 2128, 0, 1, -8843.62, 922.3882, 101.183, 3.639014, 0, 0, -0.9692307, 0.2461543, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(14121, 28045, 0, 1, -8529.818, 495.8429, 111.2916, 3.813545, 0, 0, -0.9440889, 0.3296909, 120, 120, 0, 0),
(14133, 28046, 0, 1, -8458.723, 695.6537, 111.5686, 2.242746, 0, 0, 0.9006977, 0.4344464, 120, 120, 0, 0);
...
-- reuse just deleted guids
INSERT INTO gameobject (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, rotation0, rotation1, rotation2, rotation3, spawntimesecsmin, spawntimesecsmax, animprogress, state) VALUES
(14135, 103796, 0, 1, -8508.698, 658.082, 100.5641, 2.172932, 0, 0, 0.8849869, 0.465616, 120, 120, 0, 0);
