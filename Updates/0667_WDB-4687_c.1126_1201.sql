...
-- Additional fixes based on diff with classic/wotlkmangos
UPDATE `creature` SET `spawndist` = 15, `MovementType` = 1 WHERE `guid` = 4361 AND `id` = 1201; -- classicmangos
DELETE FROM `creature_movement` WHERE `id` = 4361; -- duplicate path guid 398 (guard)

UPDATE `creature` SET `spawndist` = 10, `MovementType` = 1 WHERE `guid` = 4377 AND `id` = 1196; -- wotlkmangos
DELETE FROM `creature_movement` WHERE `id` = 4377; -- duplicate path guid 1021 (guard)
...
DELETE FROM creature_addon WHERE guid=2902;
DELETE FROM creature_movement WHERE Id=2902;
DELETE FROM game_event_creature WHERE guid=2902;
DELETE FROM game_event_creature_data WHERE guid=2902;
DELETE FROM creature_battleground WHERE guid=2902;
DELETE FROM creature_linking WHERE guid=2902
 OR master_guid=2902;
DELETE FROM creature WHERE guid=2902 AND `id` = 1201; -- duplicate 2903, sharing spawn node? (1201/1196)
