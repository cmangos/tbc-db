...
(@GUID + 0, @DOOM, 230, 1, 0, 0, 759.862, 58.2598, -53.6085, 3.9619, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 1, @WEAP, 230, 1, 0, 0, 759.862, 58.2598, -53.6085, 3.9619, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 2, @DOOM, 230, 1, 0, 0, 756.804, 55.0023, -53.5866, 0.715585, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 3, @WEAP, 230, 1, 0, 0, 756.804, 55.0023, -53.5866, 0.715585, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 4, @DOOM, 230, 1, 0, 0, 756.6, 52.5513, -53.5831, 3.90954, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 5, @WEAP, 230, 1, 0, 0, 756.6, 52.5513, -53.5831, 3.90954, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 6, @DOOM, 230, 1, 0, 0, 760.166, 55.6209, -53.6182, 3.24631, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 7, @WEAP, 230, 1, 0, 0, 760.166, 55.6209, -53.6182, 3.24631, @TIME, 0, 0, 9298, 0, 0, 0),
-- 
(@GUID + 8, @DOOM, 230, 1, 0, 0, 809.952, 49.7623, -53.559, 1.22173, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 9, @WEAP, 230, 1, 0, 0, 809.952, 49.7623, -53.559, 1.22173, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 10, @DOOM, 230, 1, 0, 0, 804.537, 50.8482, -53.5804, 0.139626, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 11, @WEAP, 230, 1, 0, 0, 804.537, 50.8482, -53.5804, 0.139626, @TIME, 0, 0, 9298, 0, 0, 0),
--
(@GUID + 12, @DOOM, 230, 1, 0, 0, 786.798, -42.1107, -53.6505, 0.366519, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 13, @WEAP, 230, 1, 0, 0, 786.798, -42.1107, -53.6505, 0.366519, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 14, @DOOM, 230, 1, 0, 0, 793.538, -34.395, -53.631, 5.28835, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 15, @WEAP, 230, 1, 0, 0, 793.538, -34.395, -53.631, 5.28835, @TIME, 0, 0, 9298, 0, 0, 0);
...
INSERT INTO `creature` VALUES
(@GUID + 16, @DOOM, 230, 1, 0, 0, 759.628, 61.429, -53.5742, 3.21141, @TIME, 0, 0, 9298, 0, 0, 0),
--
(@GUID + 17, @WEAP, 230, 1, 0, 0, 755.346, 51.0896, -53.57, 1.0472, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 18, @WEAP, 230, 1, 0, 0, 755.999, 61.6141, -53.5721, 6.21337, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 19, @WEAP, 230, 1, 0, 0, 757.366, 59.5952, -53.5933, 0.837758, @TIME, 0, 0, 9298, 0, 0, 0),
--
(@GUID + 20, @WEAP, 230, 1, 0, 0, 778.728, 42.3766, -53.6518, 2.19911, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 21, @WEAP, 230, 1, 0, 0, 776.288, 43.6711, -53.6518, 0.418879, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 22, @WEAP, 230, 1, 0, 0, 781.008, 46.79, -53.6518, 3.52557, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 23, @WEAP, 230, 1, 0, 0, 778.715, 47.5265, -53.6518, 4.7822, @TIME, 0, 0, 9298, 0, 0, 0),
--
(@GUID + 24, @WEAP, 230, 1, 0, 0, 791.143, -40.9252, -53.6506, 3.85718, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 25, @WEAP, 230, 1, 0, 0, 787.464, -40.3752, -53.6493, 5.23599, @TIME, 0, 0, 9298, 0, 0, 0),
--
(@GUID + 26, @WEAP, 230, 1, 0, 0, 806.096, 54.2448, -53.5767, 5.48033, @TIME, 0, 0, 9298, 0, 0, 0),
-- 
(@GUID + 27, @WEAP, 230, 1, 0, 0, 794.78, -35.9308, -53.6368, 2.04204, @TIME, 0, 0, 9298, 0, 0, 0);

-- Static Wrath Hammer Construct and Ragereaver Golem
DELETE FROM `creature` WHERE `guid` BETWEEN @GUID + 28 AND @GUID + 33;
INSERT INTO `creature` VALUES
(@GUID + 28, @RAGE, 230, 1, 0, 0, 779.212, 44.9612, -53.6518, 3.19395, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 29, @WRAT, 230, 1, 0, 0, 779.212, 44.9612, -53.6518, 3.19395, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 30, @RAGE, 230, 1, 0, 0, 807.141, 52.1214, -53.5713, 3.1765, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 31, @WRAT, 230, 1, 0, 0, 807.141, 52.1214, -53.5713, 3.1765, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 32, @RAGE, 230, 1, 0, 0, 789.356, -42.4263, -53.6514, 1.95477, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 33, @WRAT, 230, 1, 0, 0, 789.356, -42.4263, -53.6514, 1.95477, @TIME, 0, 0, 9298, 0, 0, 0);
...
INSERT INTO `creature` VALUES
(@GUID + 34, @RAGE, 230, 1, 0, 0, 794.549, 2.11547, -53.6519, 3.28122, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 35, @WRAT, 230, 1, 0, 0, 794.549, 2.11547, -53.6519, 3.28122, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 36, @RAGE, 230, 1, 0, 0, 793.348, -9.29995, -53.6518, 3.07178, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 37, @WRAT, 230, 1, 0, 0, 793.348, -9.29995, -53.6518, 3.07178, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 38, @RAGE, 230, 1, 0, 0, 780.244, -9.44037, -53.6513, 1.72788, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 39, @WRAT, 230, 1, 0, 0, 780.244, -9.44037, -53.6513, 1.72788, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 40, @RAGE, 230, 1, 0, 0, 779.154, 1.81084, -53.6518, 0.0174533, @TIME, 0, 0, 9298, 0, 0, 0),
(@GUID + 41, @WRAT, 230, 1, 0, 0, 779.154, 1.81084, -53.6518, 0.0174533, @TIME, 0, 0, 9298, 0, 0, 0);
...
INSERT INTO `creature` VALUES
(@GUID + 42, @DOOM, 230, 1, 0, 0, 803.859, 12.9567, -53.6615, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 43, @WEAP, 230, 1, 0, 0, 803.859, 12.9567, -53.6615, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 44, @WEAP, 230, 1, 0, 0, 762.349, 41.594, -53.7146, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 45, @DOOM, 230, 1, 0, 0, 782.138, -45.6668, -53.7721, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 46, @WEAP, 230, 1, 0, 0, 782.138, -45.6668, -53.7721, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 47, @DOOM, 230, 1, 0, 0, 782.138, -45.6668, -53.7721, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 48, @WEAP, 230, 1, 0, 0, 792.438, 45.7173, -53.7176, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 49, @WEAP, 230, 1, 0, 0, 773.925, 3.11658, -53.7172, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 50, @DOOM, 230, 1, 0, 0, 811.87, -25.2166, -53.6904, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2),
(@GUID + 51, @WEAP, 230, 1, 0, 0, 811.87, -25.2166, -53.6904, 3.9619, @TIME, 0, 0, 9298, 0, 0, 2);
