...
UPDATE `creature` SET `movementtype` = 2 WHERE `guid` = 32382 AND `id` = 12862;
...
-- INSERT INTO `creature` (`guid`, `id`, `id2`, `id3`, `id4`, `map`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `health_percent`, `mana_percent`, `movementtype`, `spawn_flags`, `visibility_mod`, `patch_min`, `patch_max`) VALUES
-- (81, 11822, 0, 0, 0, 1, 7546.30, -3034.33, 463.46, 1.11689, 300, 300, 0, 100, 100, 0, 0, 0, 0, 10), -- classic only - tbc+ 22835 Guid: 42387
-- (116, 11822, 0, 0, 0, 1, 7537.79, -3029.95, 463.46, 1.10166, 300, 300, 0, 100, 100, 0, 0, 0, 0, 10); -- 22835 Guid: 42361

-- allow Bessany Plainswind to roam
UPDATE `creature` SET `position_x` = 8005.35, `position_y` = -2496.49, `position_z` = 492.126, `movementtype` = 1, `spawndist` = 10 WHERE `guid` = 42330 AND `id` = 11796;
...
-- Withered Protector waypoints - already added in cmangos
-- UPDATE `creature` SET `movementtype` = 2 WHERE `guid` = 39489;
-- INSERT INTO `creature_movement_template` (`entry`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `waittime`, `spawndist`, `script_id`) VALUES
