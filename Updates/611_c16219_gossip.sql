...
(7159, 50215, 0, 10011); -- q.9143 rewarded
...
DELETE FROM npc_text WHERE ID=50215;
INSERT INTO npc_text (ID, text0_1, prob0) VALUES
(50215, 'I\'m sure that help from Farstrider Enclave will be here soon to help me and this useless lieutenant get to safety. You might not want to stick around; I\'ve heard all sorts of strange sounds coming from the lake and that village over yonder.', 1);
