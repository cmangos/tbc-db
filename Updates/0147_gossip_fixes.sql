...
DELETE FROM gossip_menu WHERE entry IN (7208,7209,7210,7212,7213);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7208, 8498, 0, 0),
(7209, 8499, 0, 0),
(7210, 8500, 0, 0),
(7212, 8502, 0, 0),
(7213, 8503, 0, 0);
DELETE FROM gossip_menu_option WHERE menu_id=7208;
INSERT INTO gossip_menu_option (menu_id, id, option_icon, option_text, option_broadcast_text, option_id, npc_option_npcflag, action_menu_id, action_poi_id, action_script_id, box_coded, box_money, box_text, box_broadcast_text, condition_id) VALUES
...
DELETE FROM gossip_menu WHERE entry IN (7123,7124,7125,7152);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7123, 8385, 0, 0),
(7124, 8386, 0, 0),
(7125, 8387, 0, 0),
...
DELETE FROM gossip_menu WHERE entry IN (7126,7127,7128,7129,7130,7131,7132,7133,7134,7135,7150);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7126, 8397, 0, 0),
(7127, 8396, 0, 0),
(7128, 8395, 0, 0),
...
(7135, 8388, 0, 0),
(7150, 8414, 0, 0);
DELETE FROM gossip_menu_option WHERE menu_id IN (7135,7134,7133,7132,7131,7130,7129,7128,7127);
INSERT INTO gossip_menu_option (menu_id, id, option_icon, option_text, option_broadcast_text, option_id, npc_option_npcflag, action_menu_id, action_poi_id, action_script_id, box_coded, box_money, box_text, box_broadcast_text, condition_id) VALUES
(7135, 0, 0, 'What Guardian? I don''t understand any of this.', 12023, 1, 1, 7134, 0, 0, 0, 0, '', 0, 0),
(7134, 0, 0, 'Please continue.', 12031, 1, 1, 7133, 0, 0, 0, 0, '', 0, 0),
(7133, 0, 0, 'What corruption?', 12027, 1, 1, 7132, 0, 0, 0, 0, '', 0, 0),
(7132, 0, 0, 'Please continue.', 12031, 1, 1, 7131, 0, 0, 0, 0, '', 0, 0),
(7131, 0, 0, 'Please continue.', 12031, 1, 1, 7130, 0, 0, 0, 0, '', 0, 0),
(7130, 0, 0, 'What?', 12033, 1, 1, 7129, 0, 0, 0, 0, '', 0, 0),
...
DELETE FROM gossip_menu WHERE entry IN (7111,7112,7144);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7111, 8369, 0, 0),
(7112, 8370, 0, 0),
(7144, 8408, 0, 0);
...
DELETE FROM gossip_menu WHERE entry IN (7118,7119,7120,7121,7122,7145);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7118, 8380, 0, 0),
(7119, 8381, 0, 0),
(7120, 8382, 0, 0),
...
DELETE FROM gossip_menu WHERE entry IN (7106,7107,7108,7151);
INSERT INTO gossip_menu (entry, text_id, script_id, condition_id) VALUES
(7106, 8363, 0, 0),
(7107, 8364, 0, 0),
(7108, 8365, 0, 0),
