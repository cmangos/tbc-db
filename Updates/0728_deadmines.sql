...
(639, 60124, 3, 1, -60124, 1, 0, 'NPC LOOT (Green World Drop) - (Item Levels: 19-23) - (NPC Levels: 20)'),
(639, 60443, 0.1, 1, -60443, 1, 0, 'NPC LOOT (White World Drop) - (Item Levels: 25 (10 Slot Bag)) - (NPC Levels: 21-30)'),
(639, 60200, 0.1, 1, -60200, 1, 0, 'NPC LOOT (Blue World Drop) - (Item Levels: 20) - (NPC Levels: 20)');
