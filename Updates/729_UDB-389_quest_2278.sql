...
(2278,4,0,0,0,7172,50,7,2000000823,0,0,0,0,0,0,0,'7172 yell');
UPDATE quest_template SET StartScript = 2278 WHERE entry = 2278;
DELETE FROM db_script_string WHERE entry IN (2000000823,2000000824);
INSERT INTO db_script_string (entry, content_default, sound, type, language, emote, comment) VALUES 
(2000000823,'Greetings, mortals! I have been activated by the Discs of Norgannon to assist you!',0,1,0,0,NULL),
(2000000824,'The discs are now ready! Engage the Discs of Norgannon once again to retrieve them!',0,1,0,0,NULL);
...
(575, 0, 0, 0, 0, 0, 0, 0, 2000000824, 0, 0, 0, 0, 0, 0, 0, '7172 yell');
