...
-- Kurinnaxx
UPDATE `creature_template` SET `HealthMultiplier`='50', `PowerMultiplier`='10', `MinLevelHealth`='333100', `MaxLevelHealth`='333100', `MinMeleeDmg`='1757', `MaxMeleeDmg`='2330' WHERE `Entry`='15348';
...
-- Buru the Gorger
UPDATE `creature_template` SET `HealthMultiplier`='125', `PowerMultiplier`='180', `MinLevelHealth`='666250', `MaxLevelHealth`='666250', `MinMeleeDmg`='767', `MaxMeleeDmg`='1015' WHERE `Entry`='15370';
...
-- Moam
UPDATE `creature_template` SET `HealthMultiplier`='65', `PowerMultiplier`='10', `MinLevelHealth`='346450', `MaxLevelHealth`='346450', `MinMeleeDmg`='1738', `MaxMeleeDmg`='2301' WHERE `Entry`='15340';

-- Ossirian the Unscarred
UPDATE `creature_template` SET `HealthMultiplier`='75', `PowerMultiplier`='50', `MinLevelHealth`='499650', `MaxLevelHealth`='499650', `MinMeleeDmg`='2372', `MaxMeleeDmg`='3145' WHERE `Entry`='15339';
...
-- Obsidian Destroyer
UPDATE `creature_template` SET `HealthMultiplier`='10', `PowerMultiplier`='5', `MinLevelHealth`='50300', `MaxLevelHealth`='50300', `MinMeleeDmg`='1379', `MaxMeleeDmg`='1825' WHERE `Entry`='15338';
