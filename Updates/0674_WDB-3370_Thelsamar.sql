...
UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8239 AND `id` = 2506; -- Mountaineer Harn

-- Mountaineer Ozmok 2510
UPDATE creature SET spawndist = 3, MovementType = 1 WHERE id = 2510;
-- UPDATE `creature` SET `position_x` = -5348.558, `position_y` = -2959.377, `position_z` = 323.6342, `MovementType` = 1, `spawndist` = 2 WHERE `guid` = 8745 AND `id` = 2510; -- Mountaineer Ozmok
...
-- UPDATE `creature` SET `position_x` = -5348.819, `position_y` = -2979.105, `position_z` = 324.2709, `MovementType` = 1, `spawndist` = 2 WHERE `guid` = 8736 AND `id` = 2517; -- Mountaineer Langarr
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8240 AND `id` = 2508; -- Mountaineer Wuar
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8234 AND `id` = 2509; -- Mountaineer Cragg
...
-- UPDATE `creature` SET `position_x` = -5254.075, `position_y` = -3045.504, `position_z` = 339.2725, `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8302 AND `id` = 2507; -- Mountaineer Uthan
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8303 AND `id` = 2511; -- Mountaineer Bludd
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8233 AND `id` = 2518; -- Mountaineer Swarth
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8306 AND `id` = 2512; -- Mountaineer Roghan
...
-- UPDATE `creature` SET `MovementType` = 1, `spawndist` = 5 WHERE `guid` = 8238 AND `id` = 2515; -- Mountaineer Fazgard
DELETE FROM creature_movement WHERE id IN (8236);

-- Mountaineer Kamdar 2516 - Static

-- Mountaineer Gwarth 1337 - this one has a path
...
-- UPDATE `creature` SET `MovementType` = 2, `spawndist` = 0 WHERE `guid` = 8237 AND `id` = 2513; -- Mountaineer Janha
